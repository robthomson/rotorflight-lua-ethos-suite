...
local smartfuel = assert(loadfile("tasks/scheduled/sensors/lib/smartfuel.lua"))()
local smartfuelvoltage = assert(loadfile("tasks/scheduled/sensors/lib/smartfuelvoltage.lua"))()
