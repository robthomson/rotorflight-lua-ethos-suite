...
return {data = data, read = read, setRebuildOnWrite = setRebuildOnWrite, readComplete = readComplete, readVersion = readVersion, readRfVersion = readRfVersion, readValue = readValue, setCompleteHandler = handlers.setCompleteHandler, setErrorHandler = handlers.setErrorHandler, setUUID = setUUID, setTimeout = setTimeout}
