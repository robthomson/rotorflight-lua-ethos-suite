...
if rfsuite.utils.apiVersionCompare(">=", "12.09") then  
    swashType = {"None", "Direct", "CPPM 120", "CPPM 135", "CPPM 140", "FPM 90 L", "FPM 90 V", "FPM 90 X"}
else
    swashType = {"None", "Direct", "CPPM 120", "CPPM 135", "CPPM 140", "FPM 90 L", "FPM 90 V"}
end    
...
local MSP_API_STRUCTURE_READ_DATA = {
    ...
    { field = "tail_center_trim", type = "S16", apiVersion = 12.06, simResponse = {165, 1}, unit = "%", default = 0, min = -500, max = 500, decimals = 1, scale = 10, mult = 0.239923224568138, help = "@i18n(api.MIXER_CONFIG.tail_center_trim)@" },
    { field = "swash_type", type = "U8", apiVersion = 12.06, simResponse = {0}, table = swashType, tableIdxInc = -1, help = "@i18n(api.MIXER_CONFIG.swash_type)@" },
    ...
    { field = "swash_trim_0", type = "S16", apiVersion = 12.06, simResponse = {0, 0}, unit = "%", default = 0, min = -1000, max = 1000, decimals = 1, scale = 10, help = "@i18n(api.MIXER_CONFIG.swash_trim_0)@" },
    { field = "swash_trim_1", type = "S16", apiVersion = 12.06, simResponse = {0, 0}, unit = "%", default = 0, min = -1000, max = 1000, decimals = 1, scale = 10, help = "@i18n(api.MIXER_CONFIG.swash_trim_1)@" },
    { field = "swash_trim_2", type = "S16", apiVersion = 12.06, simResponse = {0, 0}, unit = "%", default = 0, min = -1000, max = 1000, decimals = 1, scale = 10, help = "@i18n(api.MIXER_CONFIG.swash_trim_2)@" },
    ...
    { field = "swash_geo_correction", type = "S8", apiVersion = 12.07, simResponse = {10}, unit = "%",default = 0, min = -250, max = 250, decimals = 1, scale = 5, step = 2, help = "@i18n(api.MIXER_CONFIG.swash_geo_correction)@" },
    { field = "collective_tilt_correction_pos", type = "S8", apiVersion = 12.08, simResponse = {3}, unit = "°", default = 0, min = -100, max = 100, help = "@i18n(api.MIXER_CONFIG.collective_tilt_correction_pos)@" },
    { field = "collective_tilt_correction_neg", type = "S8", apiVersion = 12.08, simResponse = {11}, unit = "°", default = 10, min = -100, max = 100, help = "@i18n(api.MIXER_CONFIG.collective_tilt_correction_neg)@" },
}
-- LuaFormatter on
