...
local MSP_API_STRUCTURE_READ_DATA = {
    { field = "board_identifier_1", type = "U8",  apiVersion = 12.06, simResponse = {82}, mandatory = false },
    { field = "board_identifier_2", type = "U8",  apiVersion = 12.06, simResponse = {70}, mandatory = false },
    { field = "board_identifier_3", type = "U8",  apiVersion = 12.06, simResponse = {76}, mandatory = false },
    { field = "board_identifier_4", type = "U8",  apiVersion = 12.06, simResponse = {84}, mandatory = false },
    { field = "hardware_revision",  type = "U16", apiVersion = 12.06, simResponse = {0, 0}, mandatory = false },
    { field = "fc_type",            type = "U8",  apiVersion = 12.06, simResponse = {0}, mandatory = false },
    { field = "target_capabilities",type = "U8",  apiVersion = 12.06, simResponse = {0}, mandatory = false },
    { field = "target_name_length", type = "U8",  apiVersion = 12.06, simResponse = {0}, mandatory = false },
}
for i = 1, TARGET_NAME_MAX do
    MSP_API_STRUCTURE_READ_DATA[#MSP_API_STRUCTURE_READ_DATA + 1] = { field = "target_name_" .. i, type = "U8", apiVersion = 12.06, simResponse = {0}, mandatory = false }
end
MSP_API_STRUCTURE_READ_DATA[#MSP_API_STRUCTURE_READ_DATA + 1] = { field = "board_name_length", type = "U8", apiVersion = 12.06, simResponse = {0}, mandatory = false }
for i = 1, BOARD_NAME_MAX do
    MSP_API_STRUCTURE_READ_DATA[#MSP_API_STRUCTURE_READ_DATA + 1] = { field = "board_name_" .. i, type = "U8", apiVersion = 12.06, simResponse = {0}, mandatory = false }
end
MSP_API_STRUCTURE_READ_DATA[#MSP_API_STRUCTURE_READ_DATA + 1] = { field = "board_design_length", type = "U8", apiVersion = 12.06, simResponse = {0}, mandatory = false }
for i = 1, BOARD_DESIGN_MAX do
    MSP_API_STRUCTURE_READ_DATA[#MSP_API_STRUCTURE_READ_DATA + 1] = { field = "board_design_" .. i, type = "U8", apiVersion = 12.06, simResponse = {0}, mandatory = false }
end
MSP_API_STRUCTURE_READ_DATA[#MSP_API_STRUCTURE_READ_DATA + 1] = { field = "manufacturer_id_length", type = "U8", apiVersion = 12.06, simResponse = {0}, mandatory = false }
for i = 1, MANUFACTURER_ID_MAX do
    MSP_API_STRUCTURE_READ_DATA[#MSP_API_STRUCTURE_READ_DATA + 1] = { field = "manufacturer_id_" .. i, type = "U8", apiVersion = 12.06, simResponse = {0}, mandatory = false }
end
for i = 1, 32 do
    MSP_API_STRUCTURE_READ_DATA[#MSP_API_STRUCTURE_READ_DATA + 1] = { field = "signature_" .. i, type = "U8", apiVersion = 12.06, simResponse = {0}, mandatory = false }
end
MSP_API_STRUCTURE_READ_DATA[#MSP_API_STRUCTURE_READ_DATA + 1] = { field = "mcu_type_id", type = "U8", apiVersion = 12.06, simResponse = {0}, mandatory = false }
