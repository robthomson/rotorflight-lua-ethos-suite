...
local MSP_API_STRUCTURE_READ_DATA = {
    ...
    {field = "main_revision",             type = "U8",   apiVersion = {12, 0, 9}, simResponse = {16}},
    {field = "sub_revision",              type = "U8",   apiVersion = {12, 0, 9}, simResponse = {7}},
    {field = "layout_revision",           type = "U8",   apiVersion = {12, 0, 9}, simResponse = {33}},
    {field = "p_gain",                    type = "U8",   apiVersion = {12, 0, 9}, simResponse = {255}},
    {field = "i_gain",                    type = "U8",   apiVersion = {12, 0, 9}, simResponse = {255}},
    {field = "governor_mode",             type = "U8",   apiVersion = {12, 0, 9}, simResponse = {255}},
    {field = "low_voltage_limit",         type = "U8",   apiVersion = {12, 0, 9}, simResponse = {255}},
    {field = "motor_gain",                type = "U8",   apiVersion = {12, 0, 9}, simResponse = {255}},
    {field = "motor_idle",                type = "U8",   apiVersion = {12, 0, 9}, simResponse = {255}},
    {field = "startup_power",             type = "U8",   apiVersion = {12, 0, 9}, simResponse = {9}, table = startupPower},
    {field = "pwm_frequency",             type = "U8",   apiVersion = {12, 0, 9}, simResponse = {255}},
    ...
    {field = "programming_by_tx",         type = "U8",   apiVersion = {12, 0, 9}, simResponse = {1}, table = onOff},
    {field = "rearm_at_start",            type = "U8",   apiVersion = {12, 0, 9}, simResponse = {255}},
    ...
    {field = "ppm_min_throttle",          type = "U8",   apiVersion = {12, 0, 9}, simResponse = {37}, min = 1000, max = 1500, step = 4},
    {field = "ppm_max_throttle",          type = "U8",   apiVersion = {12, 0, 9}, simResponse = {208}, min = 1504, max = 2020, step = 4},
    ...
    {field = "ppm_center_throttle",       type = "U8",   apiVersion = {12, 0, 9}, simResponse = {122}, min = 1000, max = 2020, step = 4},
    {field = "spoolup_time",              type = "U8",   apiVersion = {12, 0, 9}, simResponse = {255}},
    {field = "temperature_protection",    type = "U8",   apiVersion = {12, 0, 9}, simResponse = {7},  table = temperatureProtection},
    {field = "low_rpm_power_protection",  type = "U8",   apiVersion = {12, 0, 9}, simResponse = {1}, table = onOff},
    ...
    {field = "reserved_29",               type = "U8",   apiVersion = {12, 0, 9}, simResponse = {255}},
    {field = "reserved_2a",               type = "U8",   apiVersion = {12, 0, 9}, simResponse = {255}},
