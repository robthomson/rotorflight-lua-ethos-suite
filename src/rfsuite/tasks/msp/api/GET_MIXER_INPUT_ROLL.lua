...
--        do not benifit from generic handling.
    { field = "rate_stabilized_roll", type = "U16", apiVersion = 12.09, simResponse = { 250, 0 }},
...
local function write(suppliedPayload)
    ...
    local v = {
        index = FIXED_INDEX,
        rate_stabilized_roll  = (payloadData.rate_stabilized_roll ~= nil) and payloadData.rate_stabilized_roll or curRate,
        min_stabilized_roll   = (payloadData.min_stabilized_roll  ~= nil) and payloadData.min_stabilized_roll  or curMin,
        max_stabilized_roll   = (payloadData.max_stabilized_roll  ~= nil) and payloadData.max_stabilized_roll  or curMax,
    }
