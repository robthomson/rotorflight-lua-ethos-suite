...
local FACTORY_SINGLETON_KEY = "rfsuite.shared.mspapi.factory"

if package.loaded[FACTORY_SINGLETON_KEY] then
    return package.loaded[FACTORY_SINGLETON_KEY]
end
...
package.loaded[FACTORY_SINGLETON_KEY] = factory
