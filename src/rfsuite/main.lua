...
rfsuite.shared.beepers = assert(loadfile("shared/beepers.lua"))()
rfsuite.shared.blackbox = assert(loadfile("shared/blackbox.lua"))()
rfsuite.shared.blackboxConfig = assert(loadfile("shared/blackboxconfig.lua"))()
rfsuite.shared.craft = assert(loadfile("shared/craft.lua"))()
rfsuite.shared.esc = assert(loadfile("shared/esc.lua"))()
rfsuite.shared.flight = assert(loadfile("shared/flight.lua"))()
rfsuite.shared.lifecycle = assert(loadfile("shared/lifecycle.lua"))()
rfsuite.shared.modelPreferences = assert(loadfile("shared/modelpreferences.lua"))()
rfsuite.shared.rx = assert(loadfile("shared/rx.lua"))()
rfsuite.shared.servo = assert(loadfile("shared/servo.lua"))()
