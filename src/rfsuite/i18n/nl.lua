...
return {
    ...
    ["api"] = {
        ...
        ["ESC_PARAMETERS_HW5"] = {["tbl_cw"] = "CW", ["tbl_fixedwing"] = "Fixed Wing", ["tbl_disabled"] = "Uit", ["tbl_ccw"] = "CCW", ["tbl_heligov"] = "Heli Governor", ["tbl_softcutoff"] = "Soft Cutoff", ["tbl_proportional"] = "Proportional", ["tbl_heliext"] = "Heli Ext Governor", ["tbl_helistore"] = "Heli Governor Store", ["tbl_hardcutoff"] = "Hard Cutoff", ["tbl_normal"] = "Normaal", ["tbl_autocalculate"] = "Auto Calculate", ["tbl_enabled"] = "Aan", ["tbl_reverse"] = "Omgekeerd"},
        ["PILOT_CONFIG"] = {["model_param1_value"] = "Stel deze in op de verwachtte flight tijd in seconds. De zender zal piepen als de tijd bereikt is."},
        ["BATTERY_INI"] = {["calcfuel_local"] = "Bereken brandstof verbruik", ["tbl_off"] = "Stroom sensor", ["tbl_on"] = "Voltage sensor", ["sag_multiplier"] = "Verhoog of verlaag om de hoeveelheid voltage dip te veranderen tijdens de vlucht.", ["alert_off"] = "Uit", ["alert_bec"] = "BEC", ["alert_rxbatt"] = "Rx Bat"},
        ["BATTERY_CONFIG"] = {
        ...
        ["ACC_TRIM"] = {["pitch"] = "Gebruik de trim als de heli niet stil hangt in de stabilisatie modes (angle, horizon, etc.).", ["roll"] = "Gebruik de trim als de heli niet stil hangt in de stabilisatie modes (angle, horizon, etc.)."},
        ["PID_TUNING"] = {
    ...
    ["app"] = {
        ...
        ["modules"] = {
            ...
            ["stats"] = {["name"] = "Status", ["totalflighttime"] = "Totale Flight tijd", ["flightcount"] = "Aantal vluchten", ["lastflighttime"] = "Tijd laatste vlucht", ["help_p1"] = "Gebruik deze module om de flight statistieken te updaten op de flight controller."},
            ["settings"] = {
                ["name"] = "Instellingen",
            ...
            ["validate_sensors"] = {["help_p1"] = "Deze tool probeert een beknopt overzicht te geven van alle sensoren die u niet ontvangt.", ["invalid"] = "INVALID", ["name"] = "Sensors", ["msg_repair"] = "Zet de benodigde sensoren aan in de vliegcontroller?", ["msg_repair_fin"] = "Is de vliegcontroller geconfigureerd? Het is waarschijnlijk benodigd om opnieuw 'Vind nieuwe sensoren' te gebruiken", ["ok"] = "OK", ["help_p2"] = "Met deze tool kunt u controleren of u de juiste sensoren verzendt."},
            ["msp_exp"] = {["help_p1"] = "Deze tool biedt de mogelijkheid om een ​​aangepaste bytestring naar de flight controller te sturen. Het is handig voor ontwikkelaars bij het debuggen van waarden.", ["name"] = "MSP Experimenteel", ["help_p2"] = "Als je niet begrijpt wat je doet, gebruik het dan niet, want er kunnen rare dingen gebeuren."},
            ["esc_tools"] = {
                ["unknown"] = "Onbekend",
                ["name"] = "ESC Tools",
            ...
            ["radio_config"] = {["deflection"] = "Deflection", ["max_throttle"] = "Max", ["stick"] = "Stick", ["arming"] = "Arming", ["yaw_deadband"] = "Yaw", ["cyclic"] = "Cyclic", ["name"] = "Radio Config", ["help_p1"] = "Configureer uw radio settings. Stick center, arm, throttle hold, en throttle cut.\n", ["min_throttle"] = "Min", ["throttle"] = "Throttle", ["deadband"] = "Deadband", ["center"] = "Center"},
            ["profile_select"] = {
            ...
            ["logs"] = {["help_logs_p2"] = "Let op. Om logging in te schakelen, is het essentieel dat u de volgende sensoren hebt ingeschakeld.", ["name"] = "Logs", ["help_logs_p1"] = "Selecteer een logbestand uit onderstaande lijst.", ["msg_no_logs_found"] = "Geen log bestand gevonden", ["help_logs_tool_p1"] = "Gebruik de schuifbalk om door de grafiek te navigeren.\n", ["help_logs_p3"] = "- arm status, voltage, headspeed, current, esc temperature"},
            ["battery"] = {
            ...
            ["accelerometer"] = {["help_p1"] = "De accelerometer wordt gebruikt om de hoek van de flight controller te meten ten opzichte van de horizon. Deze data wordt gebruikt om het vliegtuig te stabiliseren en zelf leveling functionaliteit te bieden.", ["name"] = "Versnellingsmeter", ["pitch"] = "Pitch", ["msg_calibrate"] = "Kalibreer de versnellingsmeter?", ["roll"] = "Roll"},
            ["rates"] = {
            ...
            ["info"] = {["ethos_version"] = "Ethos Versie", ["rf_version"] = "Rotorflight Versie", ["fc_version"] = "FC Versie", ["name"] = "Info", ["supported_versions"] = "Ondersteunde MSP Versies", ["simulation"] = "Simulatie", ["version"] = "Versie", ["msp_version"] = "MSP Versie", ["msp_transport"] = "MSP Transport"},
            ["rates_advanced"] = {
            ...
            ["profile_pidbandwidth"] = {["help_p1"] = "PID Bandwidth: Totale bandbreedte in Hz die door de PID-loop wordt gebruikt.", ["pitch"] = "P", ["yaw"] = "Y", ["name"] = "PID Bandbreedte", ["bterm_cutoff"] = "B-term cut-off", ["help_p3"] = "B-term cutoff: B-term afsnijdingsfrequentie in HZ.\n\n", ["dterm_cutoff"] = "D-term cut-off", ["help_p2"] = "D-term cutoff: D-term afsnijdingsfrequentie in HZ.", ["roll"] = "R"}
        },
    ...
    ["widgets"] = {
        ["bbl"] = {["erase_dataflash"] = "Gegevensflash wissen", ["erasing"] = "Bezig met wissen...", ["display"] = "Weergave", ["display_free"] = "Vrij", ["display_used"] = "Gebruikt", ["display_outof"] = "Gebruikt/Totaal"},
        ["craftimage"] = {},
        ["craftname"] = {["txt_enter_craft_name"] = "Vul Model naam in", ["title"] = "Model naam", ["txt_cancel"] = "Cancel", ["txt_save"] = "Opslaan"},
        ["dashboard"] = {
        ...
        ["governor"] = {["UNKNOWN"] = "ONBEKEND", ["IDLE"] = "IDLE", ["DISARMED"] = "DISARMED", ["OFF"] = "UIT", ["SPOOLUP"] = "OPSTARTEN", ["ACTIVE"] = "ACTIEF", ["RECOVERY"] = "HERSTELLEN", ["THROFF"] = "THR-UIT", ["LOSTHS"] = "LOST-HS", ["AUTOROT"] = "AUTOROT", ["DISABLED"] = "UITGESCHAKELD", ["BAILOUT"] = "BAILOUT"}
    }
}
