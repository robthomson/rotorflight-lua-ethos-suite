...
return {
    ...
    ["api"] = {
        ...
        ["ESC_PARAMETERS_HW5"] = {["tbl_cw"] = "CW", ["tbl_fixedwing"] = "Fixed Wing", ["tbl_disabled"] = "Disabled", ["tbl_ccw"] = "CCW", ["tbl_heligov"] = "Heli Governor", ["tbl_softcutoff"] = "Soft Cutoff", ["tbl_proportional"] = "Proportional", ["tbl_heliext"] = "Heli Ext Governor", ["tbl_helistore"] = "Heli Governor Store", ["tbl_hardcutoff"] = "Hard Cutoff", ["tbl_normal"] = "Normal", ["tbl_autocalculate"] = "Auto Calculate", ["tbl_enabled"] = "Enabled", ["tbl_reverse"] = "Reverse"},
        ["PILOT_CONFIG"] = {["model_param1_value"] = "Set this to the expected flight time in seconds.  The transmitter will beep when the flight time is reached."},
        ["BATTERY_INI"] = {["calcfuel_local"] = "Calculate Fuel Using", ["tbl_off"] = "Current Sensor", ["tbl_on"] = "Voltage Sensor", ["sag_multiplier"] = "Raise or lower to adjust for the amount of voltage sag you see in flight.", ["alert_off"] = "Off", ["alert_bec"] = "BEC", ["alert_rxbatt"] = "RxBatt"},
        ["BATTERY_CONFIG"] = {
        ...
        ["ACC_TRIM"] = {["pitch"] = "Use to trim if the heli drifts in one of the stabilized modes (angle, horizon, etc.).", ["roll"] = "Use to trim if the heli drifts in one of the stabilized modes (angle, horizon, etc.)."},
        ["PID_TUNING"] = {
    ...
    ["app"] = {
        ...
        ["navigation_help"] = "?",
        ["modules"] = {
            ["diagnostics"] = {["name"] = "Diagnostics", ["help_p1"] = "This module provides various tools to help diagnose issues with your flight controller or configuration."},
            ["stats"] = {["name"] = "Stats", ["totalflighttime"] = "Total Flight Time", ["flightcount"] = "Flight Count", ["lastflighttime"] = "Last Flight Time", ["help_p1"] = "Use this module to update the recorded flight statistics on the flight controller."},
            ["settings"] = {
                ["name"] = "Settings",
            ...
            ["validate_sensors"] = {["help_p1"] = "This tool attempts to list all the sensors that you are not receiving in a concise list.", ["invalid"] = "INVALID", ["name"] = "Sensors", ["msg_repair"] = "Enable required sensors on flight controller?", ["msg_repair_fin"] = "The flight controller has been configured? You may need to perform a discover sensors to see the changes.", ["ok"] = "OK", ["help_p2"] = "Use this tool to ensure you are sending the correct sensors."},
            ["msp_exp"] = {["help_p1"] = "This tool provides the ability to send a custom byte string to the flight controller. It is useful for developers when debugging values.", ["name"] = "MSP Expermental", ["help_p2"] = "If you do not understand what you are doing, do not use it as bad things can happen."},
            ["esc_tools"] = {
                ["unknown"] = "UNKNOWN",
                ["name"] = "ESC Tools",
            ...
            ["copyprofiles"] = {["profile_type"] = "Profile Type", ["profile_type_pid"] = "PID", ["profile_type_rate"] = "Rate", ["msgbox_save"] = "Save settings", ["name"] = "Copy Profiles", ["help_p1"] = "Copy PID profile or Rate profile from Source to Destination.", ["dest_profile"] = "Dest. Profile", ["source_profile"] = "Source Profile", ["msgbox_msg"] = "Save current page to flight controller?", ["help_p2"] = "Choose the source and destinations and save to copy the profile."},
            ["esc_motors"] = {
            ...
            ["radio_config"] = {["deflection"] = "Deflection", ["max_throttle"] = "Max", ["stick"] = "Stick", ["arming"] = "Arming", ["yaw_deadband"] = "Yaw", ["cyclic"] = "Cyclic", ["name"] = "Radio Config", ["help_p1"] = "Configure your radio settings. Stick center, arm, throttle hold, and throttle cut.", ["min_throttle"] = "Min", ["throttle"] = "Throttle", ["deadband"] = "Deadband", ["center"] = "Center"},
            ["profile_select"] = {
            ...
            ["logs"] = {["help_logs_p2"] = "Note. To enable logging it is essential for you to have the following sensors enabled.", ["name"] = "Logs", ["help_logs_p1"] = "Please select a log file from the list below.", ["msg_no_logs_found"] = "NO LOG FILES FOUND", ["help_logs_tool_p1"] = "Please use the slider to navigate the graph.", ["help_logs_p3"] = "- arm status, voltage, headspeed, current, esc temperature"},
            ["battery"] = {
            ...
            ["accelerometer"] = {["help_p1"] = "The accelerometer is used to measure the angle of the flight controller in relation to the horizon. This data is used to stabilize the aircraft and provide self-leveling functionality.", ["name"] = "Accelerometer", ["pitch"] = "Pitch", ["msg_calibrate"] = "Calibrate the accelerometer?", ["roll"] = "Roll"},
            ["rates"] = {
            ...
            ["mixer"] = {["help_p1"] = "Adust swash plate geometry, phase angles, and limits.", ["collective_tilt_correction_pos"] = "Positive", ["geo_correction"] = "Geo Correction", ["swash_tta_precomp"] = "TTA Precomp", ["name"] = "Mixer", ["collective_tilt_correction_neg"] = "Negative", ["tail_motor_idle"] = "Tail Idle Thr%", ["swash_phase"] = "Phase Angle", ["collective_tilt_correction"] = "Collective Tilt Correction", ["swash_pitch_limit"] = "Total Pitch Limit"},
            ["info"] = {["ethos_version"] = "Ethos Version", ["rf_version"] = "Rotorflight Version", ["fc_version"] = "FC Version", ["name"] = "Info", ["supported_versions"] = "Supported MSP Versions", ["simulation"] = "Simulation", ["version"] = "Version", ["msp_version"] = "MSP Version", ["msp_transport"] = "MSP Transport"},
            ["rates_advanced"] = {
            ...
            ["rfstatus"] = {["name"] = "Status", ["error"] = "ERROR", ["ok"] = "OK", ["unknown"] = "UNKNOWN", ["mspsensor"] = "MSP Sensor", ["rfmodule"] = "RF Module", ["bgtask"] = "Background Task", ["telemetrysensors"] = "Telemetry Sensors"},
            ["fblstatus"] = {
            ...
            ["profile_pidbandwidth"] = {["help_p1"] = "PID Bandwidth: Overall bandwidth in HZ used by the PID loop.", ["pitch"] = "P", ["yaw"] = "Y", ["name"] = "PID Bandwidth", ["bterm_cutoff"] = "B-term cut-off", ["help_p3"] = "B-term cutoff: B-term cutoff frequency in HZ.", ["dterm_cutoff"] = "D-term cut-off", ["help_p2"] = "D-term cutoff: D-term cutoff frequency in HZ.", ["roll"] = "R"}
        },
    ...
    ["widgets"] = {
        ["bbl"] = {["erase_dataflash"] = "Erase dataflash", ["erasing"] = "Erasing...", ["display"] = "Display", ["display_free"] = "Free", ["display_used"] = "Used", ["display_outof"] = "Used/Total"},
        ["craftimage"] = {},
        ["craftname"] = {["txt_enter_craft_name"] = "Enter Craft Name", ["title"] = "CRAFT NAME", ["txt_cancel"] = "Cancel", ["txt_save"] = "Save"},
        ["dashboard"] = {
        ...
        ["governor"] = {["UNKNOWN"] = "UNKNOWN", ["IDLE"] = "IDLE", ["DISARMED"] = "DISARMED", ["OFF"] = "OFF", ["SPOOLUP"] = "SPOOLUP", ["ACTIVE"] = "ACTIVE", ["RECOVERY"] = "RECOVERY", ["THROFF"] = "THR-OFF", ["LOSTHS"] = "LOST-HS", ["AUTOROT"] = "AUTOROT", ["DISABLED"] = "DISABLED", ["BAILOUT"] = "BAILOUT"}
    }
}
