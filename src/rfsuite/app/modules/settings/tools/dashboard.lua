...
local function openPage(pidx, title, script)
    ...
    for i in pairs(rfsuite.app.gfx_buttons) do if i ~= "settings_dashboard" then rfsuite.app.gfx_buttons[i] = nil end end
    ...
    rfsuite.app.ui.fieldHeader("@i18n(app.modules.settings.name)@" .. " / " .. "@i18n(app.modules.settings.dashboard)@")
...
local function wakeup()
    ...
    if currState ~= prevConnectedState then
        ...
        rfsuite.app.formFields[3]:enable(currState)
