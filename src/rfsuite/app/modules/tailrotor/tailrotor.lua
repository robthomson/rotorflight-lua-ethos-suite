...
local apidata = {
    ...
    formdata = {
        ...
        fields = {
            ...
            {t = "@i18n(app.modules.profile_governor.tta_gain)@", inline = 2, label = 4, mspapi = 2, apikey = "governor_tta_gain", enablefunction = function() return (rfsuite.session.governorMode >= 2) end}, 
            {t = "@i18n(app.modules.profile_governor.tta_limit)@", inline = 1, label = 4, mspapi = 2, apikey = "governor_tta_limit", enablefunction = function() return (rfsuite.session.governorMode >= 2) end}
        }
    }
}
