...
local apidata = {
    ...
    formdata = {
        ...
        fields = {
            -- Row 1: Roll
            {row = 1, col = 1, min = 0,    max = 1000, default = 18,  mult = 10,  decimals = 0, step = 10, mspapi = 1, apikey = "rcRates_1"},
            {row = 1, col = 2, min = 0,    max = 1000, default = 24,  mult = 10,  decimals = 0, step = 10, mspapi = 1, apikey = "rates_1"},
            {row = 1, col = 3, min = 0,    max = 1000, default = 0,   decimals = 2, scale = 100, mspapi = 1, apikey = "rcExpo_1"},
            -- Row 2: Pitch
            {row = 2, col = 1, min = 0,    max = 1000, default = 18,  mult = 10,  decimals = 0, step = 10, mspapi = 1, apikey = "rcRates_2"},
            {row = 2, col = 2, min = 0,    max = 1000, default = 24,  mult = 10,  decimals = 0, step = 10, mspapi = 1, apikey = "rates_2"},
            {row = 2, col = 3, min = 0,    max = 1000, default = 0,   decimals = 2, scale = 100, mspapi = 1, apikey = "rcExpo_2"},
            -- Row 3: Yaw
            {row = 3, col = 1, min = 0,    max = 1000, default = 18,  mult = 10,  decimals = 0, step = 10, mspapi = 1, apikey = "rcRates_3"},
            {row = 3, col = 2, min = 0,    max = 1000, default = 40,  mult = 10,  decimals = 0, step = 10, mspapi = 1, apikey = "rates_3"},
