...
fields[#fields + 1] = {t = "Gov-P", vals = {mspHeaderBytes + 37, mspHeaderBytes + 36} , min = 0, max = 100, default = 45}
fields[#fields + 1] = {t = "Gov-I", vals = {mspHeaderBytes + 39, mspHeaderBytes + 38} , min = 0, max = 100, default = 35}
