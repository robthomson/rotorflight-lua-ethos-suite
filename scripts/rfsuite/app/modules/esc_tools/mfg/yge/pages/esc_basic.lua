...
local mspapi = {
    ...
    formdata = {
        ...
        fields = {
            ...
            {t = rfsuite.i18n.get("app.modules.esc_tools.mfg.yge.direction"),         inline = 1, label = "esc2", type = 1, mspapi = 1, apikey="flags->direction"},
            {t = rfsuite.i18n.get("app.modules.esc_tools.mfg.yge.lv_bec_voltage"),    inline = 1, label = "esc3", mspapi = 1, apikey="lv_bec_voltage"},
            {t = rfsuite.i18n.get("app.modules.esc_tools.mfg.yge.f3c_auto"),           inline = 1, label = "esc4", type = 1, mspapi = 1, apikey="flags->f3cauto"},
