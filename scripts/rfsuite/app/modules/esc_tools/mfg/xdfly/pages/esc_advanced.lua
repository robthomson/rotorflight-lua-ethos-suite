...
local apidata = {
    ...
    formdata = {
        labels = {},
        fields = {
            {t = "@i18n(app.modules.esc_tools.mfg.xdfly.timing)@", activeFieldPos = 4, mspapi = 1, type = 1, apikey = "timing"}, {t = "@i18n(app.modules.esc_tools.mfg.xdfly.acceleration)@", activeFieldPos = 9, mspapi = 1, type = 1, apikey = "acceleration"}, {t = "@i18n(app.modules.esc_tools.mfg.xdfly.brake_force)@", activeFieldPos = 14, mspapi = 1, apikey = "brake_force"},
            {t = "@i18n(app.modules.esc_tools.mfg.xdfly.sr_function)@", activeFieldPos = 15, mspapi = 1, type = 1, apikey = "sr_function"}, {t = "@i18n(app.modules.esc_tools.mfg.xdfly.capacity_correction)@", activeFieldPos = 16, mspapi = 1, apikey = "capacity_correction"}, {t = "@i18n(app.modules.esc_tools.mfg.xdfly.auto_restart_time)@", activeFieldPos = 10, mspapi = 1, type = 1, apikey = "auto_restart_time"},
