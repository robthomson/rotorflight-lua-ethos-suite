...
local apidata = {
    ...
    formdata = {
        ...
        fields = {
            {t = "@i18n(app.modules.profile_tailrotor.precomp_cutoff)@", mspapi = 1, apikey = "yaw_precomp_cutoff"}, {t = "@i18n(app.modules.profile_tailrotor.gain)@", inline = 2, label = 2, mspapi = 1, apikey = "yaw_inertia_precomp_gain", apiversiongte = 12.08},
