...
fields[#fields + 1] = {t = "", help = "profilesPitchFFCollective", inline = 1, label = "cpcomp", apikey = "pitch_collective_ff_gain"}
...
if tonumber(rfsuite.config.apiVersion) >= 12.07 then
    fields[#fields + 1] = {t = "Gain", help = "profilesCyclicCrossCouplingGain", inline = 1, label = "cycliccc1", apikey = "cyclic_cross_coupling_gain"}
else
    fields[#fields + 1] = {t = "Gain", help = "profilesCyclicCrossCouplingGain", inline = 1, label = "cycliccc1", apikey = "cyclic_cross_coupling_gain"}
end

labels[#labels + 1] = {t = "", label = "cycliccc2", inline_size = 40.15}
fields[#fields + 1] = {t = "Ratio", help = "profilesCyclicCrossCouplingRatio", inline = 1, label = "cycliccc2", apikey = "cyclic_cross_coupling_ratio"}

labels[#labels + 1] = {t = "", label = "cycliccc3", inline_size = 40.15}
if tonumber(rfsuite.config.apiVersion) >= 12.07 then
    fields[#fields + 1] = {t = "Cutoff", help = "profilesCyclicCrossCouplingCutoff", inline = 1, label = "cycliccc3", apikey = "cyclic_cross_coupling_cutoff"}
else
    fields[#fields + 1] = {t = "Cutoff", help = "profilesCyclicCrossCouplingCutoff", inline = 1, label = "cycliccc3", apikey = "cyclic_cross_coupling_cutoff"}
end
