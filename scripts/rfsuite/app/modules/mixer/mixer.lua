...
local mspapi = {
    ...
    formdata = {
        ...
        fields = {
            ...
            {t = rfsuite.i18n.get("app.modules.mixer.collective_tilt_correction_pos"),  api = "MIXER_CONFIG:collective_tilt_correction_pos", inline = 1, label = 1, apiversiongte = 12.08},
            {t = rfsuite.i18n.get("app.modules.mixer.collective_tilt_correction_neg"),  api = "MIXER_CONFIG:collective_tilt_correction_neg", inline = 1, label = 2, apiversiongte = 12.08},
