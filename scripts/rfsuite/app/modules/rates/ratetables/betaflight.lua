local mspapi = {
    ...
    formdata = {
        ...
        fields = {
            ...
            {row = 3, col = 2, min = 0, max = 100, default = 0,   decimals = 2, scale = 100, mspapi = 1, apikey = "rates_3"},
            {row = 4, col = 2, min = 0, max = 100, default = 1,   decimals = 2, scale = 100, mspapi = 1, apikey = "rates_4"},
            -- expo
