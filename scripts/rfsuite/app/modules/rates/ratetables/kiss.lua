...
-- fc rate
fields[#fields + 1] = {row = 1, col = 2, min = 0, max = 99, default = 0, decimals = 2, scale = 100, apikey = "rates_1"}
fields[#fields + 1] = {row = 2, col = 2, min = 0, max = 99, default = 0, decimals = 2, scale = 100, apikey = "rates_2"}
fields[#fields + 1] = {row = 3, col = 2, min = 0, max = 99, default = 0, decimals = 2, scale = 100, apikey = "rates_3"}
fields[#fields + 1] = {row = 4, col = 2, min = 0, max = 99, default = 1, decimals = 2, scale = 100, apikey = "rates_4"}
--  expo
