...
local MSP_API_STRUCTURE_READ_DATA = {
    ...
    {field = "yaw_dynamic_ceiling_gain", type = "U8",  apiVersion = 12.08, simResponse = {30}},
    {field = "yaw_dynamic_deadband_gain", type = "U8", apiVersion = 12.08, simResponse = {30}},
    {field = "yaw_dynamic_deadband_filter", type = "U8", apiVersion = 12.08, simResponse = {60}},
