...
local MSP_API_STRUCTURE_READ_DATA = {
    ...
    {field = "rcRates_1", type = "U8", apiVersion = 12.06, simResponse = {18}, help = "@i18n(api.RC_TUNING.rcRates_1)@"}, {field = "rcExpo_1", type = "U8", apiVersion = 12.06, simResponse = {25}, help = "@i18n(api.RC_TUNING.rcExpo_1)@"},
    {field = "rates_1", type = "U8", apiVersion = 12.06, simResponse = {32}, help = "@i18n(api.RC_TUNING.rates_1)@"}, {field = "response_time_1", type = "U8", apiVersion = 12.06, simResponse = {20}, min = 0, max = 250, unit = "ms", help = "@i18n(api.RC_TUNING.response_time_1)@"},
    ...
    {field = "rcRates_2", type = "U8", apiVersion = 12.06, simResponse = {18}, help = "@i18n(api.RC_TUNING.rcRates_2)@"}, {field = "rcExpo_2", type = "U8", apiVersion = 12.06, simResponse = {25}, help = "@i18n(api.RC_TUNING.rcExpo_2)@"},
    {field = "rates_2", type = "U8", apiVersion = 12.06, simResponse = {32}, help = "@i18n(api.RC_TUNING.rates_2)@"}, {field = "response_time_2", type = "U8", apiVersion = 12.06, simResponse = {20}, min = 0, max = 250, unit = "ms", help = "@i18n(api.RC_TUNING.response_time_2)@"},
    ...
    {field = "rcRates_3", type = "U8", apiVersion = 12.06, simResponse = {32}, help = "@i18n(api.RC_TUNING.rcRates_3)@"}, {field = "rcExpo_3", type = "U8", apiVersion = 12.06, simResponse = {50}, help = "@i18n(api.RC_TUNING.rcExpo_3)@"},
    {field = "rates_3", type = "U8", apiVersion = 12.06, simResponse = {45}, help = "@i18n(api.RC_TUNING.rates_3)@"}, {field = "response_time_3", type = "U8", apiVersion = 12.06, simResponse = {10}, min = 0, max = 250, unit = "ms", help = "@i18n(api.RC_TUNING.response_time_3)@"},
    ...
    {field = "rcRates_4", type = "U8", apiVersion = 12.06, simResponse = {56}, help = "@i18n(api.RC_TUNING.rcRates_4)@"}, {field = "rcExpo_4", type = "U8", apiVersion = 12.06, simResponse = {0}, help = "@i18n(api.RC_TUNING.rcExpo_4)@"},
    {field = "rates_4", type = "U8", apiVersion = 12.06, simResponse = {56}, help = "@i18n(api.RC_TUNING.rates_4)@"}, {field = "response_time_4", type = "U8", apiVersion = 12.06, simResponse = {20}, min = 0, max = 250, unit = "ms", help = "@i18n(api.RC_TUNING.response_time_4)@"},
