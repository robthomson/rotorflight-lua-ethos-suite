...
local MSP_API_STRUCTURE_READ_DATA = {
    ...
    {field = "tail_center_trim",               type = "U16", apiVersion = 12.06, simResponse = {165, 1}, default = 0,  min = -500, max = 500, decimals = 1, scale = 10, mult = 0.239923224568138, help ="Sets tail rotor trim for 0 yaw for variable pitch, or tail motor throttle for 0 yaw for motorized."},
    ...
    {field = "swash_trim_0",                   type = "U16", apiVersion = 12.06, simResponse = {0, 0}, default = -1000, min = -1000, max = 1000, decimals = 1, scale = 10, help ="Swash trim to level the swash plate when using fixed links."},
    {field = "swash_trim_1",                   type = "U16", apiVersion = 12.06, simResponse = {0, 0}, default = -1000,  min = -1000, max = 1000, decimals = 1, scale = 10, help ="Swash trim to level the swash plate when using fixed links."},
    {field = "swash_trim_2",                   type = "U16", apiVersion = 12.06, simResponse = {0, 0},default = -1000,  min = -1000, max = 1000, decimals = 1, scale = 10, help ="Swash trim to level the swash plate when using fixed links."},
