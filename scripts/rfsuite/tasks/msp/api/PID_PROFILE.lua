...
local MSP_API_STRUCTURE_READ_DATA = {
    ...
    {field = "error_rotation",                  type = "U8", apiVersion = 12.06, simResponse = {1},   min = 0,   max = 1,   table = {[0] = "@i18n(api.PID_PROFILE.tbl_off)@", "@i18n(api.PID_PROFILE.tbl_on)@"}},
    ...
    {field = "iterm_relax_type",                type = "U8", apiVersion = 12.06, simResponse = {2},   min = 0,   max = 2,   table = {[0] = "@i18n(api.PID_PROFILE.tbl_off)@", "@i18n(api.PID_PROFILE.tbl_rp)@", "@i18n(api.PID_PROFILE.tbl_rpy)@"}},
