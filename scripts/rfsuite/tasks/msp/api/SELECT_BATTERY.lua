...
-- we have 6 battery profiles to choose from
-- note that the apiVersion is 12.08.  This if for RF2.2.  
-- Its possible this will have to be 12.09 as not sure this will get
-- into rf2.2
local MSP_API_STRUCTURE_READ_DATA = {
    {field = "id",      type = "U8",  apiVersion = 12.08, min=0, max=5},    
}
