...
local MSP_API_STRUCTURE_READ_DATA = {
    ...
    {field = "governor",                type = "U8",  apiVersion = 12.07, simResponse = {0}},
    {field = "cell_count",              type = "U8",  apiVersion = 12.07, simResponse = {6}},
    {field = "low_voltage_protection",  type = "U8",  apiVersion = 12.07, simResponse = {30}},
    {field = "temperature_protection",  type = "U8",  apiVersion = 12.07, simResponse = {125}},
    {field = "bec_voltage",             type = "U8",  apiVersion = 12.07, simResponse = {0}},
    {field = "timing_angle",            type = "U8",  apiVersion = 12.07, simResponse = {10}},
    {field = "motor_direction",         type = "U8",  apiVersion = 12.07, simResponse = {0}},
    {field = "starting_torque",         type = "U8",  apiVersion = 12.07, simResponse = {3}},
    {field = "response_speed",          type = "U8",  apiVersion = 12.07, simResponse = {5}},
    {field = "buzzer_volume",           type = "U8",  apiVersion = 12.07, simResponse = {1}},
    {field = "current_gain",            type = "S8",  apiVersion = 12.07, simResponse = {20}},
    {field = "fan_control",             type = "U8",  apiVersion = 12.07, simResponse = {0}},
    {field = "soft_start",              type = "U8",  apiVersion = 12.07, simResponse = {15}},
    {field = "gov_p",                   type = "U16", apiVersion = 12.07, simResponse = {0, 45},       byteorder = "big"},
    {field = "gov_i",                   type = "U16", apiVersion = 12.07, simResponse = {0, 35},       byteorder = "big"},
    {field = "gov_d",                   type = "U16", apiVersion = 12.07, simResponse = {0, 0},        byteorder = "big"},
    {field = "motor_erpm_max",          type = "U24", apiVersion = 12.07, simResponse = {1, 134, 160}, byteorder = "big"}
}
