...
local MSP_API_STRUCTURE_READ_DATA = {
    ...
    {field = "esc_model_1",             type = "U8",  apiVersion = 12.07, simResponse = {1}},
    {field = "esc_model_2",             type = "U8",  apiVersion = 12.07, simResponse = {24}},
    {field = "esc_sn_1",                type = "U8",  apiVersion = 12.07, simResponse = {231}},
    {field = "esc_sn_2",                type = "U8",  apiVersion = 12.07, simResponse = {79}},
    {field = "esc_sn_3",                type = "U8",  apiVersion = 12.07, simResponse = {190}},
    {field = "esc_sn_4",                type = "U8",  apiVersion = 12.07, simResponse = {216}},
    {field = "esc_sn_5",                type = "U8",  apiVersion = 12.07, simResponse = {78}},
    {field = "esc_sn_6",                type = "U8",  apiVersion = 12.07, simResponse = {29}},
    {field = "esc_sn_7",                type = "U8",  apiVersion = 12.07, simResponse = {169}},
    {field = "esc_sn_8",                type = "U8",  apiVersion = 12.07, simResponse = {244}},
    {field = "esc_iap_1",               type = "U8",  apiVersion = 12.07, simResponse = {1}},
    {field = "esc_iap_2",               type = "U8",  apiVersion = 12.07, simResponse = {0}},
    {field = "esc_iap_3",               type = "U8",  apiVersion = 12.07, simResponse = {0}},
    {field = "esc_fw_1",                type = "U8",  apiVersion = 12.07, simResponse = {1}},
    {field = "esc_fw_2",                type = "U8",  apiVersion = 12.07, simResponse = {0}},
    {field = "esc_fw_3",                type = "U8",  apiVersion = 12.07, simResponse = {1}},
