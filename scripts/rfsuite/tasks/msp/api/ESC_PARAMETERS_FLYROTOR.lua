...
local MSP_API_STRUCTURE_READ_DATA = {
    ...
    {field = "drive_freq",              type = "U16", apiVersion = 12.07, simResponse = {0, 24000},    min = 20000, max = 32000, default = 24000, step = 1000, unit = "Hz",byteorder = "big" , help = "@i18n(api.ESC_PARAMETERS_FLYROTOR.drive_freq)@"},
