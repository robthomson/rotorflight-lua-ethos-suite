...
local MSP_API_STRUCTURE_READ_DATA = {
    {field = "esc_signature", type = "U8", apiVersion = 12.07, simResponse = {208}, help = "@i18n(api.ESC_PARAMETERS_OMP.esc_signature)@"}, {field = "esc_command", type = "U8", apiVersion = 12.07, simResponse = {0}, help = "@i18n(api.ESC_PARAMETERS_OMP.esc_command)@"}, {field = "esc_model", type = "U8", apiVersion = 12.07, simResponse = {23}, help = "@i18n(api.ESC_PARAMETERS_OMP.esc_model)@"},
    {field = "esc_version", type = "U8", apiVersion = 12.07, simResponse = {3}, help = "@i18n(api.ESC_PARAMETERS_OMP.esc_version)@"}, {field = "governor", type = "U16", apiVersion = 12.07, simResponse = {0, 0}, tableIdxInc = -1, table = govMode, help = "@i18n(api.ESC_PARAMETERS_OMP.governor)@"}, {field = "cell_cutoff", type = "U16", apiVersion = 12.07, simResponse = {0, 0}, tableIdxInc = -1, table = lowVoltage, help = "@i18n(api.ESC_PARAMETERS_OMP.cell_cutoff)@"},
    {field = "timing", type = "U16", apiVersion = 12.07, simResponse = {0, 0}, tableIdxInc = -1, table = timing, help = "@i18n(api.ESC_PARAMETERS_OMP.timing)@"}, {field = "lv_bec_voltage", type = "U16", apiVersion = 12.07, simResponse = {0, 0}, tableIdxInc = -1, table = becLvVoltage, help = "@i18n(api.ESC_PARAMETERS_OMP.lv_bec_voltage)@"},
    {field = "motor_direction", type = "U16", apiVersion = 12.07, simResponse = {0, 0}, tableIdxInc = -1, table = motorDirection, help = "@i18n(api.ESC_PARAMETERS_OMP.motor_direction)@"}, {field = "gov_p", type = "U16", apiVersion = 12.07, simResponse = {4, 0}, min = 1, max = 10, default = 5, offset = 1, help = "@i18n(api.ESC_PARAMETERS_OMP.gov_p)@"},
    {field = "gov_i", type = "U16", apiVersion = 12.07, simResponse = {3, 0}, min = 1, max = 10, default = 5, offset = 1, help = "@i18n(api.ESC_PARAMETERS_OMP.gov_i)@"}, {field = "acceleration", type = "U16", apiVersion = 12.07, simResponse = {0, 0}, tableIdxInc = -1, table = accel, help = "@i18n(api.ESC_PARAMETERS_OMP.acceleration)@"},
    {field = "auto_restart_time", type = "U16", apiVersion = 12.07, simResponse = {0, 0}, tableIdxInc = -1, table = autoRestart, help = "@i18n(api.ESC_PARAMETERS_OMP.auto_restart_time)@"}, {field = "hv_bec_voltage", type = "U16", apiVersion = 12.07, simResponse = {0, 0}, tableIdxInc = -1, table = becHvVoltage, help = "@i18n(api.ESC_PARAMETERS_OMP.hv_bec_voltage)@"},
    {field = "startup_power", type = "U16", apiVersion = 12.07, simResponse = {0, 0}, table = startupPower, tableIdxInc = -1, help = "@i18n(api.ESC_PARAMETERS_OMP.startup_power)@"}, {field = "brake_type", type = "U16", apiVersion = 12.07, simResponse = {0, 0}, tableIdxInc = -1, table = brakeType, help = "@i18n(api.ESC_PARAMETERS_OMP.brake_type)@"},
    {field = "brake_force", type = "U16", apiVersion = 12.07, simResponse = {0, 0}, min = 0, max = 100, default = 0, unit = "%", help = "@i18n(api.ESC_PARAMETERS_OMP.brake_force)@"}, {field = "sr_function", type = "U16", apiVersion = 12.07, simResponse = {0, 0}, table = srFunc, tableIdxInc = -1, help = "@i18n(api.ESC_PARAMETERS_OMP.sr_function)@"},
    {field = "capacity_correction", type = "U16", apiVersion = 12.07, simResponse = {0, 0}, min = 0, max = 20, default = 10, offset = -10, unit = "%", help = "@i18n(api.ESC_PARAMETERS_OMP.capacity_correction)@"}, {field = "motor_poles", type = "U16", apiVersion = 12.07, simResponse = {9, 0}, min = 1, max = 55, default = 10, step = 1, offset = 1, help = "@i18n(api.ESC_PARAMETERS_OMP.motor_poles)@"},
    {field = "led_color", type = "U16", apiVersion = 12.07, simResponse = {0, 0}, tableIdxInc = -1, table = ledColor, help = "@i18n(api.ESC_PARAMETERS_OMP.led_color)@"}, {field = "smart_fan", type = "U16", apiVersion = 12.07, simResponse = {0, 0}, tableIdxInc = -1, table = fanControl, help = "@i18n(api.ESC_PARAMETERS_OMP.smart_fan)@"}, {field = "activefields", type = "U32", apiVersion = 12.07, simResponse = {238, 255, 1, 0}, help = "@i18n(api.ESC_PARAMETERS_OMP.activefields)@"}
}
