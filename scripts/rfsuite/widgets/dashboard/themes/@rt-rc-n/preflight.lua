...
local function buildBoxes(W)
    ...
    return {
      ...
      },
      {
        ...
        thresholds = {
          { value = i18n("widgets.governor.DISARMED"), textcolor = colorMode.fillcolor },
          { value = i18n("widgets.governor.OFF"),      textcolor = colorMode.fillcolor },
          { value = i18n("widgets.governor.IDLE"),     textcolor = colorMode.accent    },
          { value = i18n("widgets.governor.SPOOLUP"),  textcolor = colorMode.primary   },
          { value = i18n("widgets.governor.RECOVERY"), textcolor = colorMode.secondary },
          { value = i18n("widgets.governor.ACTIVE"),   textcolor = colorMode.fillcolor },
          { value = i18n("widgets.governor.THR-OFF"),  textcolor = colorMode.fillcolor },
        }
      },
      {
        col     = 5,
