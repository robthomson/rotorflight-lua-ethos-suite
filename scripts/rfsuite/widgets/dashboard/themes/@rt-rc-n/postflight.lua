...
local themeOptions = {
    ...
    ls_full = {font = "FONT_XXL", valuepaddingtop = 0},

    ls_std = {font = "FONT_XL", valuepaddingtop = 0},

    ms_full = {font = "FONT_XL", valuepaddingtop = 10},

    ms_std = {font = "FONT_XL", valuepaddingtop = 5},

    ss_full = {font = "FONT_XL", valuepaddingtop = 10},

    ss_std = {font = "FONT_XL", valuepaddingtop = 10}
}
...
local function buildBoxes(W)
    ...
    return {
        ...
        {col = 1, row = 2, type = "time", subtype = "total", opts.font, title = "@i18n(widgets.dashboard.total_flight_duration)@", titlepos = "bottom", valuepaddingtop = opts.valuepaddingtop, bgcolor = colorMode.bgcolor, textcolor = colorMode.textcolor, titlecolor = colorMode.titlecolor}, {
            ...
            stattype = "min",
            source = "rpm",
            title = "@i18n(widgets.dashboard.rpm_min)@",
            ...
            source = "link",
            opts.font,
            title = "@i18n(widgets.dashboard.link_max)@",
            valuepaddingtop = opts.valuepaddingtop,
            titlepos = "bottom",
            bgcolor = colorMode.bgcolor,
            transform = "floor",
            ...
            source = "bec_voltage",
            opts.font,
            title = "@i18n(widgets.dashboard.min_volts_cell)@",
            valuepaddingtop = opts.valuepaddingtop,
            titlepos = "bottom",
            bgcolor = colorMode.bgcolor,
            unit = "V",
            ...
            opts.font,
            title = "@i18n(widgets.dashboard.throttle_max)@",
            valuepaddingtop = opts.valuepaddingtop,
            titlepos = "bottom",
            bgcolor = colorMode.bgcolor,
            transform = "floor",
