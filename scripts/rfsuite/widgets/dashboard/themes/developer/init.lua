...
local init = {
    name = "Developer Examples",                -- Theme name
    ...
    wakeup = 0.25,                   -- Interval (seconds) to run wakeup script when display is visible (keep round 0.25 for responsive touch events)
