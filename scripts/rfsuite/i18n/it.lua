...
return {
    ...
    ["api"] = {
        ...
        ["PILOT_CONFIG"] = {["model_param1_value"] = "Reglez cette valeur sur la duree de vol prevue, en secondes. La radiocommande emettra un bip lorsque cette duree sera atteinte."},
        ["BATTERY_INI"] = {["calcfuel_local"] = "Calculate Fuel Using", ["tbl_off"] = "Current Sensor", ["tbl_on"] = "Voltage Sensor", ["sag_multiplier"] = "Raise or lower to adjust for the amount of voltage sag you see in flight.", ["alert_off"] = "Off", ["alert_bec"] = "BEC", ["alert_rxbatt"] = "Rx Batt"},
        ["BATTERY_CONFIG"] = {
        ...
        ["ACC_TRIM"] = {["pitch"] = "Utilizzare per regolare se l'elicottero si sposta in una delle modalita' stabilizzate (angle, horizon, etc.).", ["roll"] = "Utilizzare per regolare se l'elicottero si sposta in una delle modalita' stabilizzate (angle, horizon, etc.)."},
        ["PID_TUNING"] = {
    ...
    ["app"] = {
        ...
        ["modules"] = {
            ...
            ["stats"] = {["name"] = "Stats", ["totalflighttime"] = "Totale Tempo Volo", ["flightcount"] = "Conteggio Voli", ["lastflighttime"] = "Tempo ultimo Volo", ["help_p1"] = "Usa questo modulo per aggiornare le statistiche di volo sulla radio."},
            ["settings"] = {
                ["name"] = "Impostazioni",
            ...
            ["validate_sensors"] = {["help_p1"] = "Questo strumento prova a elencare tutti i sensori che non ricevi in una lista concisa.", ["invalid"] = "INVALIDO", ["name"] = "Sensori", ["msg_repair"] = "Abilito i sensori richiesti sul flight controller?", ["msg_repair_fin"] = "Il flight controller e' stato configurato? Potresti necessitare di riscoprire i sensori per vedere i cambiamenti.", ["ok"] = "OK", ["help_p2"] = "Usa questo strumento per assicurarti di inviare i sensori corretti."},
            ["msp_exp"] = {["help_p1"] = "Questo strumento permette di inviare una stringa byte custom al flight controller. E' utile in fase di sviluppo/Debug", ["name"] = "MSP Sperimentale", ["help_p2"] = "Se non sai cosa stai facendo, non usare, le cose brutte accadono."},
            ["esc_tools"] = {
                ["unknown"] = "SCONOSCIUTO",
                ["name"] = "Strumenti ESC",
            ...
            ["radio_config"] = {["deflection"] = "Deflessione", ["max_throttle"] = "Max", ["stick"] = "Stick", ["arming"] = "Armo", ["yaw_deadband"] = "Yaw", ["cyclic"] = "Ciclico", ["name"] = "Radio Config", ["help_p1"] = "Configurare le impostazioni della radio. Centro Stick, attivazione, blocco acceleratore e disattivazione acceleratore.", ["min_throttle"] = "Min", ["throttle"] = "Throttle", ["deadband"] = "Deadband", ["center"] = "Centro"},
            ["profile_select"] = {
            ...
            ["logs"] = {["help_logs_p2"] = "Nota. Per abilitare la registrazione e' essenziale che tu abbia abilitato i seguenti sensori.", ["name"] = "Logs", ["help_logs_p1"] = "Selezionare un file log dall'elenco seguente.", ["msg_no_logs_found"] = "LOG FILES ASSENTI", ["help_logs_tool_p1"] = "Utilizza lo slider per navigare nel grafico.", ["help_logs_p3"] = "- stato armo, voltaggio, Vel.Rotore, corrente, esc temperatura"},
            ["battery"] = {
            ...
            ["accelerometer"] = {["help_p1"] = "L'accelerometro e' utilizzato per misurare l'angolo del controller di volo rispetto all'orizzonte. Questi dati sono utilizzati per stabilizzare l'aeromobile e fornire la funzionalita' di autolivellamento.", ["name"] = "Accelerometro", ["pitch"] = "Pitch", ["msg_calibrate"] = "Calibra accelerometro?", ["roll"] = "Roll"},
            ["rates"] = {
            ...
            ["info"] = {["ethos_version"] = "Versione Ethos", ["rf_version"] = "Versione Rotorflight", ["fc_version"] = "Versione FC", ["name"] = "Infor", ["supported_versions"] = "Versioni MSP Supportate", ["simulation"] = "Simulazione", ["version"] = "Versione", ["msp_version"] = "Versione MSP", ["msp_transport"] = "Trasporto MSP"},
            ["rates_advanced"] = {
            ...
            ["profile_pidbandwidth"] = {["help_p1"] = "Banda PID: Larghezza di banda complessiva in HZ utilizzata dal circuito PID", ["pitch"] = "P", ["yaw"] = "Y", ["name"] = "PID Bandwidth", ["bterm_cutoff"] = "B-term cut-off", ["help_p3"] = "B-term cutoff: Frequenza B-term cutoff in HZ.", ["dterm_cutoff"] = "D-term cut-off", ["help_p2"] = "D-term cutoff: Frequenza D-term cutoff in HZ.", ["roll"] = "R"}
        },
    ...
    ["widgets"] = {
        ["bbl"] = {["erase_dataflash"] = "Cancella memoria flash", ["erasing"] = "Cancellazione in corso...", ["display"] = "Schermo", ["display_free"] = "Libero", ["display_used"] = "Usato", ["display_outof"] = "Usato/Totale"},
        ["craftimage"] = {},
        ["craftname"] = {["txt_enter_craft_name"] = "Nome Velivolo", ["title"] = "NOME VELIVOLO", ["txt_cancel"] = "Cancella", ["txt_save"] = "Salva"},
        ["dashboard"] = {
        ...
        ["governor"] = {["UNKNOWN"] = "SCONOSCIUTO", ["IDLE"] = "MINIMO", ["DISARMED"] = "DISARMATO", ["OFF"] = "OFF", ["SPOOLUP"] = "SPOOLUP", ["ACTIVE"] = "ATTIVO", ["RECOVERY"] = "RECUPERA", ["THROFF"] = "THR-OFF", ["LOSTHS"] = "HS-PERSO", ["AUTOROT"] = "AUTOROTAZIONE", ["DISABLED"] = "DISABILITA", ["BAILOUT"] = "SALVATAGGIO"}
    }
}
