...
return {
  ...
  ["app"] = {
    ...
    ["modules"] = {
      ...
      ["profile_governor"] = {
        ["tail_torque_assist"] = "Assistenza Coppia Coda",
        ["fc_throttle_curve"] = "Curva Acceleratore FC",
        ["tx_precomp_curve"] = "Curva Precomp TX",
        ["fallback_precomp"] = "Precomp Fallback",
        ["voltage_comp"] = "Compensazione Volt",
        ["pid_spoolup"] = "PID Avvio",
        ["hs_adjustment"] = "Regolazione HS",
        ["dyn_min_throttle"] = "Minimo Dyn. Thr",
      ...
      ["fblstatus"] = {
        ...
        ["arming_disable_flag_6"] = "Segnale RPM",
        ["megabyte"] = "MB",
  ...
  ["telemetry"] = {
    ...
    ["group_voltage"] = "Tensione",
    ["group_battery"] = "Batteria",
    ["group_control"] = "Controllo",
    ["group_esc1"] = "ESC 1",
    ["group_esc2"] = "ESC 2",
    ...
    ["group_gyro"] = "Giroscopio",
    ["group_gps"] = "GPS",
    ["group_load"] = "Carico del sistema",
    ["group_status"] = "Stato",
    ["group_profiles"] = "Profili",
    ["group_tuning"] = "Regolazione",
    ["group_debug"] = "Debug",
    ["sensor_none"] = "Nessuno",
    ["sensor_heartbeat"] = "Battito cardiaco",
    ["sensor_battery"] = "Batteria",
    ["sensor_battery_voltage"] = "Battery Tensione",
    ["sensor_battery_current"] = "Battery Corrente",
    ["sensor_battery_consumption"] = "Battery Consumo",
    ["sensor_battery_charge_level"] = "Battery Livello di carica",
    ["sensor_battery_cell_count"] = "Battery Numero di celle",
    ["sensor_battery_cell_voltage"] = "Battery Tensione cella",
    ["sensor_battery_cell_voltages"] = "Battery Tensioni delle celle",
    ["sensor_control"] = "Controllo (Hi-Res)",
    ["sensor_pitch_control"] = "Controllo beccheggio",
    ["sensor_roll_control"] = "Controllo rollio",
    ["sensor_yaw_control"] = "Controllo imbardata",
    ["sensor_collective_control"] = "Controllo collettivo",
    ["sensor_throttle_control"] = "Acceleratore Control",
    ["sensor_esc1_data"] = "ESC1 Dati",
    ["sensor_esc1_voltage"] = "ESC1 Tensione",
    ["sensor_esc1_current"] = "ESC1 Corrente",
    ["sensor_esc1_capacity"] = "ESC1 Capacità",
    ["sensor_esc1_erpm"] = "ESC1 eRPM",
    ["sensor_esc1_power"] = "ESC1 Potenza",
    ["sensor_esc1_throttle"] = "ESC1 Acceleratore",
    ["sensor_esc1_temp1"] = "ESC1 Temperatura 1",
    ["sensor_esc1_temp2"] = "ESC1 Temperatura 2",
    ["sensor_esc1_bec_voltage"] = "ESC1 BEC Voltage",
    ["sensor_esc1_bec_current"] = "ESC1 BEC Current",
    ["sensor_esc1_status"] = "ESC1 Stato",
    ["sensor_esc1_model"] = "ESC1 Modello",
    ["sensor_esc2_data"] = "ESC2 Dati",
    ["sensor_esc2_voltage"] = "ESC2 Tensione",
    ["sensor_esc2_current"] = "ESC2 Corrente",
    ["sensor_esc2_capacity"] = "ESC2 Capacità",
    ["sensor_esc2_erpm"] = "ESC2 eRPM",
    ["sensor_esc2_power"] = "ESC2 Potenza",
    ["sensor_esc2_throttle"] = "ESC2 Acceleratore",
    ["sensor_esc2_temp1"] = "ESC2 Temperatura 1",
    ["sensor_esc2_temp2"] = "ESC2 Temperatura 2",
    ["sensor_esc2_bec_voltage"] = "ESC2 BEC Voltage",
    ["sensor_esc2_bec_current"] = "ESC2 BEC Current",
    ["sensor_esc2_status"] = "ESC2 Stato",
    ["sensor_esc2_model"] = "ESC2 Modello",
    ["sensor_esc_voltage"] = "ESC Tensione",
    ["sensor_bec_voltage"] = "BEC Voltage",
    ["sensor_bus_voltage"] = "Bus Voltage",
    ["sensor_mcu_voltage"] = "MCU Voltage",
    ["sensor_esc_current"] = "ESC Corrente",
    ["sensor_bec_current"] = "BEC Current",
    ["sensor_bus_current"] = "Bus Current",
    ["sensor_mcu_current"] = "MCU Current",
    ["sensor_esc_temp"] = "ESC Temperatura",
    ["sensor_bec_temp"] = "BEC Temperature",
    ["sensor_mcu_temp"] = "MCU Temperature",
    ["sensor_air_temp"] = "Temperatura aria",
    ["sensor_motor_temp"] = "Temperatura motore",
    ["sensor_battery_temp"] = "Temperatura batteria",
    ["sensor_exhaust_temp"] = "Temperatura scarico",
    ["sensor_heading"] = "Intestazione",
    ["sensor_altitude"] = "Altitudine",
    ["sensor_variometer"] = "Variometro",
    ["sensor_headspeed"] = "Velocità testa",
    ["sensor_tailspeed"] = "Velocità coda",
    ["sensor_motor_rpm"] = "Motor RPM",
    ["sensor_trans_rpm"] = "Transmission RPM",
    ["sensor_attitude"] = "Atteggiamento (Hi-Res)",
    ["sensor_attitude_pitch"] = "Atteggiamento Pitch",
    ["sensor_attitude_roll"] = "Atteggiamento Roll",
    ["sensor_attitude_yaw"] = "Atteggiamento Yaw",
    ["sensor_accel"] = "Accel (Hi-Res)",
    ["sensor_accel_x"] = "Accelerazione X",
    ["sensor_accel_y"] = "Accelerazione Y",
    ["sensor_accel_z"] = "Accelerazione Z",
    ["sensor_gps"] = "GPS",
    ["sensor_gps_sats"] = "GPS Satelliti",
    ["sensor_gps_pdop"] = "GPS PDOP",
    ["sensor_gps_hdop"] = "GPS HDOP",
    ["sensor_gps_vdop"] = "GPS VDOP",
    ["sensor_gps_coord"] = "GPS Coordinate",
    ["sensor_gps_altitude"] = "GPS Altitude",
    ["sensor_gps_heading"] = "GPS Heading",
    ["sensor_gps_groundspeed"] = "GPS Velocità al suolo",
    ["sensor_gps_home_distance"] = "GPS Distanza casa",
    ["sensor_gps_home_direction"] = "GPS Direzione casa",
    ["sensor_gps_date_time"] = "GPS Data/Ora",
    ["sensor_load"] = "Load",
    ["sensor_cpu_load"] = "Carico CPU",
    ["sensor_sys_load"] = "Carico del sistema",
    ["sensor_rt_load"] = "Carico in tempo reale",
    ["sensor_model_id"] = "ID Modello",
    ["sensor_flight_mode"] = "Modalità di volo",
    ["sensor_arming_flags"] = "Indicatori armamento",
    ["sensor_arming_disable_flags"] = "Indicatori disarmo",
    ["sensor_rescue_state"] = "Stato di salvataggio",
    ["sensor_governor_state"] = "Stato governatore",
    ["sensor_governor_flags"] = "Indicatori governatore",
    ["sensor_pid_profile"] = "Profilo PID",
    ["sensor_rates_profile"] = "Profilo velocità",
    ["sensor_battery_profile"] = "Profilo batteria",
    ["sensor_led_profile"] = "Profilo LED",
    ["sensor_adjfunc"] = "Funzione regolabile",
