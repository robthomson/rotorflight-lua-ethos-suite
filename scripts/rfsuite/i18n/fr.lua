...
return {
  ...
  ["app"] = {
    ...
    ["modules"] = {
      ...
      ["profile_governor"] = {
        ["tail_torque_assist"] = "Assistance couple queue",
        ["fc_throttle_curve"] = "Courbe gaz FC",
        ["tx_precomp_curve"] = "Courbe precomp TX",
        ["fallback_precomp"] = "Precomp secours",
        ["voltage_comp"] = "Comp tension",
        ["pid_spoolup"] = "Demarrage PID",
        ["hs_adjustment"] = "Ajust. regime rotor",
        ["dyn_min_throttle"] = "Gaz min dynamique",
      ...
      ["fblstatus"] = {
        ...
        ["arming_disable_flag_6"] = "Signal RPM",
        ["megabyte"] = "MB",
  ...
  ["telemetry"] = {
    ...
    ["group_temps"] = "Températures",
    ["group_barometer"] = "Baromètre",
    ["group_rpm"] = "RPM",
    ["group_attitude"] = "Attitude",
    ["group_gyro"] = "Gyroscope",
    ["group_gps"] = "GPS",
    ["group_load"] = "Charge du système",
    ["group_status"] = "Statut",
    ["group_profiles"] = "Profils",
    ["group_tuning"] = "Réglage",
    ["group_debug"] = "Débogage",
    ["sensor_none"] = "Aucun",
    ["sensor_heartbeat"] = "Battement de cœur",
    ["sensor_battery"] = "Batterie",
    ["sensor_battery_voltage"] = "Battery Tension",
    ["sensor_battery_current"] = "Battery Courant",
    ["sensor_battery_consumption"] = "Battery Consommation",
    ["sensor_battery_charge_level"] = "Battery Niveau de charge",
    ...
    ["sensor_collective_control"] = "Contrôle collectif",
    ["sensor_throttle_control"] = "Gaz Control",
    ["sensor_esc1_data"] = "ESC1 Données",
    ["sensor_esc1_voltage"] = "ESC1 Tension",
    ["sensor_esc1_current"] = "ESC1 Courant",
    ["sensor_esc1_capacity"] = "ESC1 Capacité",
    ["sensor_esc1_erpm"] = "ESC1 eRPM",
    ["sensor_esc1_power"] = "ESC1 Puissance",
    ["sensor_esc1_throttle"] = "ESC1 Gaz",
    ["sensor_esc1_temp1"] = "ESC1 Température 1",
    ["sensor_esc1_temp2"] = "ESC1 Température 2",
    ["sensor_esc1_bec_voltage"] = "ESC1 BEC Voltage",
    ["sensor_esc1_bec_current"] = "ESC1 BEC Current",
    ["sensor_esc1_status"] = "ESC1 Statut",
    ["sensor_esc1_model"] = "ESC1 Modèle",
    ["sensor_esc2_data"] = "ESC2 Données",
    ["sensor_esc2_voltage"] = "ESC2 Tension",
    ["sensor_esc2_current"] = "ESC2 Courant",
    ["sensor_esc2_capacity"] = "ESC2 Capacité",
    ["sensor_esc2_erpm"] = "ESC2 eRPM",
    ["sensor_esc2_power"] = "ESC2 Puissance",
    ["sensor_esc2_throttle"] = "ESC2 Gaz",
    ["sensor_esc2_temp1"] = "ESC2 Température 1",
    ["sensor_esc2_temp2"] = "ESC2 Température 2",
    ["sensor_esc2_bec_voltage"] = "ESC2 BEC Voltage",
    ["sensor_esc2_bec_current"] = "ESC2 BEC Current",
    ["sensor_esc2_status"] = "ESC2 Statut",
    ["sensor_esc2_model"] = "ESC2 Modèle",
    ["sensor_esc_voltage"] = "ESC Tension",
    ["sensor_bec_voltage"] = "BEC Voltage",
    ["sensor_bus_voltage"] = "Bus Voltage",
    ["sensor_mcu_voltage"] = "MCU Voltage",
    ["sensor_esc_current"] = "ESC Courant",
    ["sensor_bec_current"] = "BEC Current",
    ["sensor_bus_current"] = "Bus Current",
    ["sensor_mcu_current"] = "MCU Current",
    ["sensor_esc_temp"] = "ESC Température",
    ["sensor_bec_temp"] = "BEC Temperature",
    ["sensor_mcu_temp"] = "MCU Temperature",
    ["sensor_air_temp"] = "Température de l’air",
    ["sensor_motor_temp"] = "Température du moteur",
    ["sensor_battery_temp"] = "Température de la batterie",
    ["sensor_exhaust_temp"] = "Température d’échappement",
    ["sensor_heading"] = "Cap",
    ["sensor_altitude"] = "Altitude",
    ["sensor_variometer"] = "Variomètre",
    ["sensor_headspeed"] = "Vitesse de tête",
    ...
    ["sensor_gps_coord"] = "GPS Coordonnées",
    ["sensor_gps_altitude"] = "GPS Altitude",
    ["sensor_gps_heading"] = "GPS Heading",
    ["sensor_gps_groundspeed"] = "GPS Vitesse sol",
    ["sensor_gps_home_distance"] = "GPS Distance maison",
    ["sensor_gps_home_direction"] = "GPS Direction maison",
    ["sensor_gps_date_time"] = "GPS Date/Heure",
    ["sensor_load"] = "Load",
    ["sensor_cpu_load"] = "Charge CPU",
    ["sensor_sys_load"] = "Charge du système",
    ["sensor_rt_load"] = "Charge temps réel",
    ["sensor_model_id"] = "ID du modèle",
    ["sensor_flight_mode"] = "Mode de vol",
    ["sensor_arming_flags"] = "Indicateurs d’armement",
    ["sensor_arming_disable_flags"] = "Indicateurs de désarmement",
    ["sensor_rescue_state"] = "État de secours",
    ["sensor_governor_state"] = "État du régulateur",
    ["sensor_governor_flags"] = "Indicateurs du régulateur",
    ["sensor_pid_profile"] = "Profil PID",
    ["sensor_rates_profile"] = "Profil de taux",
    ["sensor_battery_profile"] = "Profil batterie",
    ["sensor_led_profile"] = "Profil LED",
    ["sensor_adjfunc"] = "Fonction réglable",
    ["sensor_debug_0"] = "Débogage 0",
    ["sensor_debug_1"] = "Débogage 1",
    ["sensor_debug_2"] = "Débogage 2",
    ["sensor_debug_3"] = "Débogage 3",
    ["sensor_debug_4"] = "Débogage 4",
    ["sensor_debug_5"] = "Débogage 5",
    ["sensor_debug_6"] = "Débogage 6",
