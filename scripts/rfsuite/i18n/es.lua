...
return {
  ...
  ["api"] = {
    ...
    ["GOVERNOR_CONFIG"] = {
      ...
      ["tbl_govmode_external"] = "EXTERNO",
      ["tbl_govmode_electric"] = "ELECTRICO",
      ["tbl_govmode_nitro"] = "NITRO",
      ["tbl_throttle_type_normal"] = "NORMAL",
      ["tbl_throttle_type_off_on"] = "APAGADO_ENCENDIDO",
      ["tbl_throttle_type_off_idle_on"] = "APAGADO_MARCHA_ENCENDIDO",
      ["tbl_throttle_type_idle_auto_on"] = "MARCHA_AUTO_ENCENDIDO",
      ["governor_idle_throttle"] = "Acelerador en marcha",
      ["governor_auto_throttle"] = "Acelerador automatico",
      ["governor_fallback_drop"] = "Caida de respaldo"
    },
    ["RC_CONFIG"] = {
  ...
  ["app"] = {
    ...
    ["modules"] = {
      ["diagnostics"] = {
        ["name"] = "Diagnóstico",
        ["help_p1"] = "Este módulo ofrece varias herramientas para diagnosticar problemas con el controlador de vuelo o la configuración."
      },
      ["stats"] = {
        ["name"] = "Estadísticas",
      ...
      ["profile_governor"] = {
        ...
        ["idle_throttle"] = "Acelerador ralentí",
        ["auto_throttle"] = "Acelerador auto",
        ["fallback_drop"] = "Caída de respaldo",
      ...
      ["governor"] = {
        ...
        ["mode"] = "Modo",
        ["throttle_type"] = "Tipo de acelerador",
        ["collective"] = "Colectivo",
        ["idle_collective"] = "Colectivo ralentí",
        ["wot_collective"] = "Colectivo máx.",
        ["throttle_hold_timeout"] = "Tiempo retención acelerador",
        ["ramp_time"] = "Tiempo de rampa",
        ["startup_time"] = "Tiempo de inicio",
        ["spoolup_time"] = "Tiempo de Arranque",
        ["spooldown_time"] = "Tiempo de apagado",
        ["tracking_time"] = "Tiempo de Tracking",
        ["help_p2"] = "Todos los parámetros son tiempos en segundos para cada acción del governor.",
        ["name"] = "Governor",
        ["gov_rpm_filter"] = "Corte Filtro RPM",
        ["gov_pwr_filter"] = "Corte Filtro Voltaje",
        ["gov_tta_filter"] = "Ancho Banda TTA",
        ["gov_ff_filter"] = "Ancho Banda Precomp",
        ["gov_d_filter"] = "Corte D-Term"
      },
      ["accelerometer"] = {
  ...
  ["telemetry"] = {
    ...
    ["group_status"] = "Estado",
    ["group_profiles"] = "Perfiles",
    ["group_tuning"] = "Ajuste",
    ["group_debug"] = "Depuración",
    ["sensor_none"] = "Ninguno",
    ["sensor_heartbeat"] = "Latido",
    ["sensor_battery"] = "Batería",
    ["sensor_battery_voltage"] = "Voltaje de batería",
    ["sensor_battery_current"] = "Corriente de batería",
    ["sensor_battery_consumption"] = "Consumo de batería",
    ["sensor_battery_charge_level"] = "Nivel de carga de batería",
    ...
    ["sensor_collective_control"] = "Control colectivo",
    ["sensor_throttle_control"] = "Control de acelerador",
    ["sensor_esc1_data"] = "Datos ESC1",
    ["sensor_esc1_voltage"] = "Voltaje ESC1",
    ["sensor_esc1_current"] = "Corriente ESC1",
    ["sensor_esc1_capacity"] = "Capacidad ESC1",
    ["sensor_esc1_erpm"] = "ESC1 eRPM",
    ["sensor_esc1_power"] = "Potencia ESC1",
    ["sensor_esc1_throttle"] = "Acelerador ESC1",
    ["sensor_esc1_temp1"] = "Temperatura ESC1 1",
    ["sensor_esc1_temp2"] = "Temperatura ESC1 2",
    ["sensor_esc1_bec_voltage"] = "Voltaje BEC ESC1",
    ["sensor_esc1_bec_current"] = "Corriente BEC ESC1",
    ["sensor_esc1_status"] = "Estado ESC1",
    ["sensor_esc1_model"] = "Modelo ESC1",
    ["sensor_esc2_data"] = "Datos ESC2",
    ["sensor_esc2_voltage"] = "Voltaje ESC2",
    ["sensor_esc2_current"] = "Corriente ESC2",
    ["sensor_esc2_capacity"] = "Capacidad ESC2",
    ["sensor_esc2_erpm"] = "ESC2 eRPM",
    ["sensor_esc2_power"] = "Potencia ESC2",
    ["sensor_esc2_throttle"] = "Acelerador ESC2",
    ["sensor_esc2_temp1"] = "Temperatura ESC2 1",
    ["sensor_esc2_temp2"] = "Temperatura ESC2 2",
    ["sensor_esc2_bec_voltage"] = "Voltaje BEC ESC2",
    ["sensor_esc2_bec_current"] = "Corriente BEC ESC2",
    ["sensor_esc2_status"] = "Estado ESC2",
    ["sensor_esc2_model"] = "Modelo ESC2",
    ["sensor_esc_voltage"] = "Voltaje ESC",
    ["sensor_bec_voltage"] = "Voltaje BEC",
    ["sensor_bus_voltage"] = "Voltaje de bus",
    ["sensor_mcu_voltage"] = "Voltaje MCU",
    ["sensor_esc_current"] = "Corriente ESC",
    ["sensor_bec_current"] = "Corriente BEC",
    ["sensor_bus_current"] = "Corriente de bus",
    ["sensor_mcu_current"] = "Corriente MCU",
    ["sensor_esc_temp"] = "Temperatura ESC",
    ["sensor_bec_temp"] = "Temperatura BEC",
    ["sensor_mcu_temp"] = "Temperatura MCU",
    ["sensor_air_temp"] = "Temperatura del aire",
    ["sensor_motor_temp"] = "Temperatura del motor",
    ["sensor_battery_temp"] = "Temperatura de batería",
    ["sensor_exhaust_temp"] = "Temperatura de escape",
    ["sensor_heading"] = "Rumbo",
    ["sensor_altitude"] = "Altitud",
    ["sensor_variometer"] = "Variometro",
    ["sensor_headspeed"] = "Velocidad de cabeza",
    ...
    ["sensor_gps"] = "GPS",
    ["sensor_gps_sats"] = "Satélites GPS",
    ["sensor_gps_pdop"] = "GPS PDOP",
    ["sensor_gps_hdop"] = "GPS HDOP",
    ["sensor_gps_vdop"] = "GPS VDOP",
    ["sensor_gps_coord"] = "Coordenadas GPS",
    ["sensor_gps_altitude"] = "Altitud GPS",
    ["sensor_gps_heading"] = "Rumbo GPS",
    ["sensor_gps_groundspeed"] = "Velocidad sobre el suelo GPS",
    ["sensor_gps_home_distance"] = "Distancia a casa GPS",
    ["sensor_gps_home_direction"] = "Dirección a casa GPS",
    ["sensor_gps_date_time"] = "Fecha/Hora GPS",
    ["sensor_load"] = "Carga",
    ["sensor_cpu_load"] = "Carga CPU",
    ["sensor_sys_load"] = "Carga del sistema",
    ["sensor_rt_load"] = "Carga en tiempo real",
    ["sensor_model_id"] = "ID de modelo",
    ["sensor_flight_mode"] = "Modo de vuelo",
    ["sensor_arming_flags"] = "Banderas de armado",
    ["sensor_arming_disable_flags"] = "Banderas de desarmado",
    ["sensor_rescue_state"] = "Estado de rescate",
    ["sensor_governor_state"] = "Estado del gobernador",
    ["sensor_governor_flags"] = "Banderas del gobernador",
    ["sensor_pid_profile"] = "Perfil PID",
    ["sensor_rates_profile"] = "Perfil de tasas",
    ["sensor_battery_profile"] = "Perfil de batería",
    ["sensor_led_profile"] = "Perfil LED",
    ["sensor_adjfunc"] = "Función ajustable",
    ["sensor_debug_0"] = "Depuración 0",
    ["sensor_debug_1"] = "Depuración 1",
    ["sensor_debug_2"] = "Depuración 2",
    ["sensor_debug_3"] = "Depuración 3",
    ["sensor_debug_4"] = "Depuración 4",
    ["sensor_debug_5"] = "Depuración 5",
    ["sensor_debug_6"] = "Depuración 6",
