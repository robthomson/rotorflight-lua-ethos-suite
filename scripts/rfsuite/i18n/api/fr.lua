...
fr = {
    ...
    GOVERNOR_CONFIG = {
        ...
        gov_spoolup_min_throttle = "Gaz minimum a utiliser pour une montee progressive, en pourcentage. Pour les moteurs electriques, la valeur par defaut est 5%, pour le nitro, elle doit être reglee pour que l'embrayage commence a s'engager en douceur 10-15%.",           
        tbl_govmode_off = "DESACTIVE", 
    ...
    MIXER_CONFIG = {
        tail_motor_idle = "Signal de gaz minimum envoye au moteur de queue. Doit être juste assez eleve pour que le moteur ne s'arrête pas.",
    ...
    ESC_PARAMETERS_HW5 = {
        ...
        tbl_heliext   = "Gouverneur Ext Heli", 
        tbl_heligov   = "Gouverneur Heli", 
        tbl_helistore = "Gouverneur Heli Stocke",
        tbl_cw = "CW",
        tbl_ccw = "CCW",
    ...
    ESC_PARAMETERS_YGE = {
        ...
        tbl_modestore = "Gouverneur Heli Stocke", 
