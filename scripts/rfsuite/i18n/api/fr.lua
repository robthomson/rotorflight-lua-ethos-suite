...
fr = {
    ...
    GOVERNOR_CONFIG = {
        ...
        governor_max_throttle = "Accelerateur de sortie maximal que le regulator est autorise a utiliser.",
        governor_min_throttle = "Accelerateur de sortie minimal que le regulator est autorise a utiliser.",
