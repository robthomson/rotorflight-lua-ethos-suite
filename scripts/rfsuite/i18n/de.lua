...
return {
  ...
  ["app"] = {
    ...
    ["modules"] = {
      ...
      ["profile_governor"] = {
        ["tail_torque_assist"] = "Heckmomenthilfe",
        ["fc_throttle_curve"] = "FC-Gaskurve",
        ["tx_precomp_curve"] = "TX-Vorkomp.Kurve",
        ["fallback_precomp"] = "Fallback-Vorkomp.",
        ["voltage_comp"] = "Spannungskomp.",
        ["pid_spoolup"] = "PID-Spoolup",
        ["hs_adjustment"] = "Drehz.Anpassung",
  ...
  ["telemetry"] = {
    ...
    ["group_tuning"] = "Einstellung",
    ["group_debug"] = "Debug",
    ["sensor_none"] = "Keine",
    ["sensor_heartbeat"] = "Herzschlag",
    ["sensor_battery"] = "Akku",
    ["sensor_battery_voltage"] = "Akkuspannung",
    ["sensor_battery_current"] = "Akkustrom",
    ["sensor_battery_consumption"] = "Akkuverbrauch",
    ["sensor_battery_charge_level"] = "Akkuladestand",
    ...
    ["sensor_collective_control"] = "Kollektivsteuerung",
    ["sensor_throttle_control"] = "Gassteuerung",
    ["sensor_esc1_data"] = "Regler 1 Daten",
    ["sensor_esc1_voltage"] = "Regler 1 Spannung",
    ["sensor_esc1_current"] = "Regler 1 Strom",
    ["sensor_esc1_capacity"] = "Regler 1 Kapazität",
    ["sensor_esc1_erpm"] = "Regler 1 eU/min",
    ["sensor_esc1_power"] = "Regler 1 Leistung",
    ["sensor_esc1_throttle"] = "Regler 1 Gas",
    ["sensor_esc1_temp1"] = "Regler 1 Temperatur 1",
    ["sensor_esc1_temp2"] = "Regler 1 Temperatur 2",
    ["sensor_esc1_bec_voltage"] = "Regler 1 BEC Spannung",
    ["sensor_esc1_bec_current"] = "Regler 1 BEC Strom",
    ["sensor_esc1_status"] = "Regler 1 Status",
    ["sensor_esc1_model"] = "Regler 1 Modell",
    ["sensor_esc2_data"] = "Regler 2 Daten",
    ["sensor_esc2_voltage"] = "Regler 2 Spannung",
    ["sensor_esc2_current"] = "Regler 2 Strom",
    ["sensor_esc2_capacity"] = "Regler 2 Kapazität",
    ["sensor_esc2_erpm"] = "Regler 2 eU/min",
    ["sensor_esc2_power"] = "Regler 2 Leistung",
    ["sensor_esc2_throttle"] = "Regler 2 Gas",
    ["sensor_esc2_temp1"] = "Regler 2 Temperatur 1",
    ["sensor_esc2_temp2"] = "Regler 2 Temperatur 2",
    ["sensor_esc2_bec_voltage"] = "Regler 2 BEC Spannung",
    ["sensor_esc2_bec_current"] = "Regler 2 BEC Strom",
    ["sensor_esc2_status"] = "Regler 2 Status",
    ["sensor_esc2_model"] = "Regler 2 Modell",
    ["sensor_esc_voltage"] = "Reglerspannung",
    ["sensor_bec_voltage"] = "BEC Spannung",
    ["sensor_bus_voltage"] = "Busspannung",
    ["sensor_mcu_voltage"] = "MCU Spannung",
    ["sensor_esc_current"] = "Reglerstrom",
    ["sensor_bec_current"] = "BEC Strom",
    ["sensor_bus_current"] = "Busstrom",
    ["sensor_mcu_current"] = "MCU Strom",
    ["sensor_esc_temp"] = "Reglertemperatur",
    ["sensor_bec_temp"] = "BEC Temperatur",
    ["sensor_mcu_temp"] = "MCU Temperatur",
    ["sensor_air_temp"] = "Lufttemperatur",
    ["sensor_motor_temp"] = "Motortemperatur",
    ["sensor_battery_temp"] = "Akkutemperatur",
    ["sensor_exhaust_temp"] = "Abgastemperatur",
    ["sensor_heading"] = "Kurs",
    ["sensor_altitude"] = "Höhe",
    ["sensor_variometer"] = "Variometer",
    ["sensor_headspeed"] = "Rotordrehzahl",
    ...
    ["sensor_gps"] = "GPS",
    ["sensor_gps_sats"] = "GPS Satelliten",
    ["sensor_gps_pdop"] = "GPS PDOP",
    ["sensor_gps_hdop"] = "GPS HDOP",
    ["sensor_gps_vdop"] = "GPS VDOP",
    ["sensor_gps_coord"] = "GPS Koordinaten",
    ["sensor_gps_altitude"] = "GPS Höhe",
    ["sensor_gps_heading"] = "GPS Kurs",
    ["sensor_gps_groundspeed"] = "GPS Geschwindigkeit",
    ["sensor_gps_home_distance"] = "GPS Entfernung zum Start",
    ["sensor_gps_home_direction"] = "GPS Richtung zum Start",
    ["sensor_gps_date_time"] = "GPS Datum/Zeit",
    ["sensor_load"] = "Auslastung",
    ["sensor_cpu_load"] = "CPU-Auslastung",
    ["sensor_sys_load"] = "Systemauslastung",
    ["sensor_rt_load"] = "Echtzeit-Auslastung",
    ["sensor_model_id"] = "Modell-ID",
    ["sensor_flight_mode"] = "Flugmodus",
    ["sensor_arming_flags"] = "Schaltflags",
    ["sensor_arming_disable_flags"] = "Schaltflags deaktiviert",
    ["sensor_rescue_state"] = "Rettungsstatus",
    ["sensor_governor_state"] = "Governer-Status",
    ["sensor_governor_flags"] = "Governer-Flags",
    ["sensor_pid_profile"] = "PID-Profil",
    ["sensor_rates_profile"] = "Rates-Profil",
    ["sensor_battery_profile"] = "Akku-Profil",
    ["sensor_led_profile"] = "LED-Profil",
    ["sensor_adjfunc"] = "Einstellbare Funktion",
