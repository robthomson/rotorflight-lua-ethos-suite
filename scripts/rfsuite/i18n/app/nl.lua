...
nl = {
    ...
    modules = {
        ...
        esc_motors = {
            name                    = "ESC/Motor",
            main_motor_ratio        = "Hoofd Motor Ratio",
            tail_motor_ratio        = "StaartMotor Ratio",
            pinion                  = "Motortandwiel",
            main                    = "Hoofdtandwiel",
            rear                    = "Achterkant",
            front                   = "Voorkant",
            motor_pole_count        = "Motor Pool aantal",
        ...
        esc_tools = {
            ...
            mfg = {
                flrtr =  {
                        ...
                        governor                = "Governor",
                        low_voltage_protection  = "Lage spanning beveiliging",
                        temperature_protection  = "Temperatuur beveiliging",
                        ...
                        motor_direction         = "Motor richting",
                ...
                hw5 =  {
                        ...
                        volt_cutoff_type        = "Lage spanning beveiliging",
                        cutoff_voltage          = "Afschakelingsspanning",
                        governor                = "Governor",
                        soft_start              = "Langzame opstart",
                        gov_p_gain              = "P-Gain",
                        gov_i_gain              = "I-Gain",
        ...
        profile_tailrotor = {
            ...
            cw                      = "CW",
            ccw                     = "CCW",
            help_p1                 = "Yaw Stop Gain: Hogere stop gain zal de tail stop agressiever maken, maar kan oscillaties veroorzaken als deze te hoog is. Pas CW of CCW aan om de yaw stops gelijkmatiger te maken.",
            help_p2                 = "Precomp Cutoff: Frequentie limiet voor alle yaw precompensatie acties.",
