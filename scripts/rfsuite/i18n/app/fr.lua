...
fr = {
     ...
     check_heli_on              = "Veuillez verifier que votre helicoptère est sous tension et connecte a la radio.",
     check_msp_version          = "Impossible de determiner la version MSP utilisee.",
     check_supported_version    = "Cette version du script Lua \nne peut pas être utilisee avec le modèle selectionne.",
 
     -- messages d'erreur
     error_timed_out            = "Erreur : delai depasse",
 
     -- messages
     msg_save_current_page      = "Enregistrer la page actuelle dans le contrôleur de vol ?",
     msg_save_settings          = "Enregistrer les paramètres",
     msg_reload_settings        = "Recharger les donnees du contrôleur de vol ?",
     ...
     msg_loading_from_fbl       = "Chargement des donnees du contrôleur de vol...",
     msg_connecting             = "Connexion",
     msg_connecting_to_fbl      = "Connexion au contrôleur de vol...",
     msg_saving                 = "Enregistrement...",
     msg_saving_to_fbl          = "Enregistrement des donnees dans le contrôleur de vol...",
    ...
    modules = {
        about = {
            ...
            opener              = "Rotorflight est un projet open source. Toute contribution de personnes partageant le même etat d'esprit, desireuses d'ameliorer encore ce logiciel, est la bienvenue et encouragee. Vous n'avez pas besoin d'être un programmeur experimente pour aider.",
        ...
        accelerometer = {
            ...
            roll =              "Roulis",
            pitch =             "Tangage",
            help_p1 =           "L'acceleromètre est utilise pour mesurer l'angle du contrôleur de vol par rapport a l'horizon. Ces donnees sont utilisees pour stabiliser l'aeronef et fournir une fonctionnalite d'auto-nivellement.",
        },
        battery = {
            name =              "Batterie",
            ...
            help_p1 =           "Les paramètres de la batterie sont utilises pour configurer le contrôleur de vol afin de surveiller la tension de la batterie et fournir des avertissements lorsque la tension descend en dessous d'un certain niveau.",
        },
        copyprofiles = {
        ...
        governor = {
            ...
            spoolup_min_throttle = "Gaz min demarrage%",
            startup_time         = "Temps demarrage",
            help_p1              = "Configurez les paramètres du gouverneur pour la gestion automatique des gaz.",
            help_p2              = "Chaque valeur represente simplement un temps en secondes pour chaque action du gouverneur."
        },
        logs = {
            name                 = "Journaux",
            ...
            help_logs_p2         = "Les journaux necessitent une analyse regulière pour surveiller le comportement de vol."
        },
        mixer = {
            name                           = "Mixeur",
        ...
        msp_exp = {
            ...
            help_p1             = "Cet outil permet d'envoyer une chaîne d'octets personnalisee au contrôleur de vol. Il est utile aux developpeurs pour le debogage des valeurs.", 
        ...
        msp_speed = {
            ...
            successful_queries   = "Requêtes reussies",
            timeouts             = "Timeouts",
            retries              = "Reessais",
            ...
            help_p1              = "Cet outil mesure la qualite de votre liaison de donnees MSP en effectuant le plus possible de grandes requêtes MSP en 30 secondes.",
        },
        pids = {
            name    = "PIDs",
            roll    = "Roulis",
            ...
            o       = "O",
            b       = "B",
            help_p1 = "FeedForward (Roulis/Tangage): Commencez a 70, augmentez jusqu'a obtenir des arrêts nets sans derive. Gardez les valeurs roulis et tangage egales.",
            help_p2 = "Gain I (Roulis/Tangage): Augmentez progressivement pour stabiliser les manœuvres rapides en pirouettes. Trop eleve provoque des oscillations; egalisez les valeurs roulis/tangage.",
            help_p3 = "Gains P/I/D de queue: Augmentez P jusqu'a un leger tremblement en funnels, puis reduisez legèrement. Montez I jusqu'a un maintien ferme de la queue dans les manœuvres rapides (trop eleve provoque une oscillation lente). Ajustez D pour des arrêts en douceur—plus eleve pour servos lents, plus faible pour servos rapides.",
            help_p4 = "Gain d'arrêt de la queue (Horaire/Anti-horaire): Ajustez separement pour des arrêts nets et sans rebonds dans les deux directions.",
        ...
        profile_autolevel = {
            ...
            gain         = "Gain",
            max          = "Max",
            help_p1      = "Entraînement Acro : Intensite avec laquelle l'helicoptère revient a l'horizontale en mode entraînement Acro.",
            help_p2      = "Mode Angle : Intensite avec laquelle l'helicoptère revient a l'horizontale en mode Angle.",
            help_p3      = "Mode Horizon : Intensite avec laquelle l'helicoptère revient a l'horizontale en mode Horizon.",
        },
        ...
        profile_mainrotor = {
            ...
            help_p4                     = "Frequence limite couplage croise : Limite frequentielle de la compensation, une valeur plus elevee accelère l'action compensatrice.",
        },
        ...
        profile_pidcontroller = {
            ...
            help_p1             = "Decroissance d'erreur au sol : Decroissance PID pour aider a empêcher l'helicoptère de basculer lorsqu'il est au sol.",
            ...
            help_p4             = "Rotation d'erreur : Permettre aux erreurs d'être partagees entre tous les axes.",
            help_p5             = "Relaxation I-term : Limiter l'accumulation de I-term lors des mouvements rapides - aide a reduire le rebond après des mouvements rapides du manche. Doit generalement être plus faible pour les grands helicoptères et peut être plus eleve pour les petits helicoptères. Il est preferable de ne reduire que ce qui est necessaire pour votre style de vol.",
        },
        profile_rescue = {
            name         = "Secours",
            ...
            hover        = "Stationnaire",
            flip         = "Retourner",
            fail_time    = "Temps d'echec",
            exit_time    = "Temps de sortie",
            level_gain   = "Niveau",
            gains        = "Gains",
            rate         = "Taux",
            accel        = "Acceleration",
            help_p1      = "Retourner a l'endroit : Retourner l'helicoptère a l'endroit lorsque le mode secours est active.",
            help_p2      = "Redresser : Combien de collectif et pendant combien de temps pour arrêter la chute.",
            help_p3      = "Montee : Combien de collectif pour maintenir une montee regulière - et combien de temps.",
            ...
            help_p6      = "Gains : Combien d'effort pour maintenir l'helicoptère a niveau lors de l'activation du mode secours.",
        ...
        profile_tailrotor = {
            ...
            cw                      = "CW",
            ccw                     = "CCW",
            help_p1                 = "Gain d'arrêt de lacet : Un gain d'arrêt plus eleve rendra l'arrêt de la queue plus agressif mais peut provoquer des oscillations s'il est trop eleve. Ajustez CW ou CCW pour rendre les arrêts de lacet uniformes.",
        ...
        rates = {
            ...
            superrate           = "SuperTaux",
            acroplus            = "Acro+",
            help_default_p1     = "Par defaut : Nous gardons cela pour faire apparaître le bouton pour les taux.",
            ...
            help_table_1_p3     = "Expo : Reduit la sensibilite près du centre du manche où des contrôles fins sont necessaires.",
            ...
            help_table_2_p3     = "Expo : Reduit la sensibilite près du centre du manche où des contrôles fins sont necessaires.",
            ...
            help_table_3_p3     = "Courbe RC : Reduit la sensibilite près du centre du manche où des contrôles fins sont necessaires.",
            help_table_4_p1     = "Sensibilite Centre : Utilisez pour reduire la sensibilite autour du centre du manche. Reglez la Sensibilite Centre a la même valeur que le Taux Max pour une reponse lineaire. Un nombre inferieur au Taux Max reduira la sensibilite autour du centre du manche. Notez qu'un nombre superieur au Taux Max augmentera le Taux Max - non recommande car cela cause des problèmes dans le journal Blackbox.",
            help_table_4_p2     = "Taux Max : Taux de rotation maximal a pleine deviation du manche en degres par seconde.",
            help_table_4_p3     = "Expo : Reduit la sensibilite près du centre du manche où des contrôles fins sont necessaires.",
            ...
            help_table_5_p3     = "Expo : Reduit la sensibilite près du centre du manche où des contrôles fins sont necessaires.",
        },
        rates_advanced = {
            name                    = "Taux",
            ...
            help_p2                 = "Dynamique : Applique independamment du type de taux. Typiquement laisse par defaut mais peut être ajuste pour lisser les mouvements de l'helicoptère, comme avec les helicoptères de maquette.",
        },
        sbusout = {
            name                = "SBUS Sortie",
        ...
        servos  = {
            ...
            help_default_p3             = "Tous les autres servos qui ne sont pas contrôles par le mixeur de vol principal s'afficheront dans la section appelee 'Autres servos'.",
        ...
        status = {
            ...
            arming_disable_flag_9   = "Temps de grâce au demarrage",
            ...
            help_p1                 = "Utilisez cette page pour voir l'etat actuel de votre contrôleur de vol. Cela peut être utile pour determiner pourquoi votre helicoptère ne s'arme pas.",
        ...
        trim = {
            ...
            enable_mixer_message        = "Reglez tous les servos a leur position centrale configuree. \r\n\r\nCela entraînera l'enregistrement de toutes les valeurs de cette page lors du reglage du trim du servo.",
            disable_mixer_message       = "Rendre le contrôle des servos au contrôleur de vol.",
            help_p1                     = "Lier les trims : Utilisez pour ajuster de petits problèmes de nivellement dans votre plateau cyclique. Typiquement utilise uniquement si les liens du plateau cyclique ne sont pas ajustables.",
