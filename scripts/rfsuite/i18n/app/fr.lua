...
fr = {
     ...
     check_bg_task              = "Veuillez activer la tâche en arriere-plan.",
     ...
     check_supported_version    = "Cette version du script Lua \nne peut pas être utilisee avec le modele selectionne.",
    ...
    modules = {
        ...
        governor = {
            ...
            spoolup_min_throttle = "Gaz minimum de démarrage %",
            startup_time         = "Temps de demarrage",
            spoolup_time         = "Temps de montee en régime",
        ...
        profile_autolevel = {
            ...
            gain         = "Gain",
            max          = "Max",
            help_p1      = "Entraînement Acro : Intensite avec laquelle l'helicoptere revient a l'horizontale en mode entraînement Acro.",
        ...
        profile_pidcontroller = {
            ...
            help_p1             = "Decroissance d'erreur au sol : Decroissance PID pour aider a empêcher l'helicoptere de basculer lorsqu'il est au sol.",
            ...
            help_p5             = "Relaxation I-term : Limiter l'accumulation de I-term lors des mouvements rapides - aide a reduire le rebond apres des mouvements rapides du manche. Doit generalement être plus faible pour les grands helicopteres et peut être plus eleve pour les petits helicopteres. Il est preferable de ne reduire que ce qui est necessaire pour votre style de vol.",
        },
        profile_rescue = {
            name         = "Secours",
        ...
        rates = {
            ...
            help_table_1_p3     = "Expo : Reduit la sensibilite pres du centre du manche où des controles fins sont necessaires.",
            ...
            help_table_2_p3     = "Expo : Reduit la sensibilite pres du centre du manche où des controles fins sont necessaires.",
            ...
            help_table_3_p3     = "Courbe RC : Reduit la sensibilite pres du centre du manche où des controles fins sont necessaires.",
            ...
            help_table_4_p3     = "Expo : Reduit la sensibilite pres du centre du manche où des controles fins sont necessaires.",
            ...
            help_table_5_p3     = "Expo : Reduit la sensibilite pres du centre du manche où des controles fins sont necessaires.",
        },
        rates_advanced = {
            name                    = "Taux",
            ...
            help_p2                 = "Dynamique : Applique independamment du type de taux. Typiquement laisse par defaut mais peut être ajuste pour lisser les mouvements de l'helicoptere, comme avec les helicopteres de maquette.",
        },
        sbusout = {
            name                = "SBUS Sortie",
        ...
        servos  = {
            ...
            help_default_p2             = "Les commandes de vol principales qui utilisent le mixeur rotorflight s'afficheront dans la section appelee 'mixeur'.",
        ...
        status = {
            ...
            help_p1                 = "Utilisez cette page pour voir l'etat actuel de votre controleur de vol. Cela peut être utile pour determiner pourquoi votre helicoptere ne s'arme pas.",
        ...
        trim = {
            ...
            help_p1                     = "Lier les trims : Utilisez pour ajuster de petits problemes de nivellement dans votre plateau cyclique. Typiquement utilise uniquement si les liens du plateau cyclique ne sont pas ajustables.",
