...
fr = {
    ...
    modules = {
        ...
        rates_advanced = {
            ...
            yaw                     = "Lacet",
            col                         = "Col.",
            response_time = "TempsRep",
            acc_limit = "LimAccel",
            setpoint_boost_gain = "GainCons",
            setpoint_boost_cutoff = "SeuilCons",
            dyn_ceiling_gain = "GainPlafond",
            dyn_deadband_gain = "GainZoneMorte",
            dyn_deadband_filter = "FiltreZoneMorte",
            rate_table = "Table des tarifs",
            help_rate_table = "Veuillez selectionner le tarif que vous souhaitez utiliser. L'enregistrement appliquera le choix au profil actif.",
        },
        sbusout = {
            name                = "SBUS Sortie",
