...
de = {
    ...
    check_heli_on              = "Bitte überprüfen Sie, ob Ihr Heli eingeschaltet und der Empfaenger verbunden ist.",
    ...
    msg_please_disarm_to_save  = "Bitte disarmen, um die Datensicherheit zu gewährleisten.",
    msg_loading                = "Lädt...",
    ...
    modules = {
        ...
        accelerometer = {
            ...
            roll =              "Roll",
            pitch =             "Nick",
            help_p1 =           "Der Beschleunigungssensor wird verwendet, um den Winkel des Flugcontrollers in Bezug auf den Horizont zu messen. Diese Daten werden zur Stabilisierung des Fluggeräts und zur Bereitstellung der Selbstnivellierungsfunktion verwendet.",
        },
        battery = {
            name =              "Batterie",
        ...
        governor = {
            ...
            help_p1              = "Diese Parameter gelten global für den Drehzahlreger (Governor), unabhängig vom verwendeten Profil.",
        ...
        pids = {
            ...
            help_p4 = "Heck-Stopp-Gain (CW/CCW): Separat anpassen für saubere, Stopps ohne Pendeln in beide Richtungen.",
        ...
        profile_governor = {
            ...
            help_p3             = "Verstärkungen: Feineinstellung des Governors.",
            help_p4             = "Vorkompensation: Governor-Vorkompensation für Gier-, zyklische und kollektive Eingaben.",
        ...
        profile_rescue = {
            ...
            help_p1      = "Aufrichten: Richtet den Heli aus dem Rückenflug auf, wenn der Rettungsmodus aktiviert wird.",
        ...
        radio_config = {
            ...
            cyclic          = "Zyklisch",
            yaw_deadband    = "Gier",
            help_p1         = "Konfigurieren Sie Ihre Fernsteuerungseinstellungen: Knüppelzentrum, Arm, Gas-Hold und Gas-Abschaltung.",
        },
        rates = {
            name                = "Rates",
            actual              = "ACTUAL",
        ...
        status = {
            ...
            erase                   = "Löschen",
            erase_prompt            = "Möchten Sie den Datenspeicher löschen?",
            ok                      = "OK",
