...
de = {
    ...
    modules = {
        ...
        rates_advanced = {
            ...
            setpoint_boost_gain = "SollwertVerst",
            setpoint_boost_cutoff = "SollwertGrenze",
            dyn_ceiling_gain = "DynDeckVerst",
            dyn_deadband_gain = "DynTotzVerst",
            dyn_deadband_filter = "DynTotzFilter",
            rate_table = "Tariftabelle",
            help_rate_table = "Bitte waehlen Sie den Tarif aus, den Sie verwenden moechten. Durch das Speichern wird die Auswahl auf das aktive Profil angewendet.",
        },
        sbusout = {
            name                = "SBUS-Ausgang",
