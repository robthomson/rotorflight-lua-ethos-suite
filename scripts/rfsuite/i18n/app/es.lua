       ...
       -- startup checks
        ...
        modules = {
            ...
            esc_tools = {
                ...
                mfg = {
                    flrtr =  {
                            ...
                            advanced                = "Avanzado",
                            governor                = "Governor",
                            low_voltage_protection  = "Protección bajo voltaje",
                            temperature_protection  = "Protección Temperatura",
                            timing_angle            = "Angulo de Timing",
                            starting_torque         = "Torque de Inicio",
                            response_speed          = "Velocidad de Respuesta",
                            buzzer_volume           = "Volúmen del Buzzer",
            ...
            profile_mainrotor = {
                ...
                collective_pitch_comp_short = "Compens. Ang. Col.",
            ...
            profile_pidcontroller = {
                ...
                inflight_error_decay = "Distensión Error en Vuelo",
            ...
            profile_tailrotor = {
                ...
                yaw_stop_gain           = "Ganacia parada rotación",
            ...
            rates_advanced = {
                ...
                pitch_dynamics          = "Dinámica de Cabeceo",
                yaw_dynamics            = "Dinámica de Rotación",
                collective_dynamics     = "Dinámica de Colectivo",
