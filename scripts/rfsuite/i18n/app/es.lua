       ...
       -- startup checks
        ...
        modules = {
            ...
            rates_advanced = {
                ...
                yaw                         = "Giro",
                col                         = "Colec.",
                response_time = "TiempoResp",
                acc_limit = "LimAceler",
                setpoint_boost_gain = "GananciaRef",
                setpoint_boost_cutoff = "CorteRef",
                dyn_ceiling_gain = "GananciaTecho",
                dyn_deadband_gain = "GananciaZonaMuerta",
                dyn_deadband_filter = "FiltroZonaMuerta",
                rate_table = "Tabla de tarifas",
                help_rate_table = "Por favor seleccione la tarifa que desea usar. Al guardar se aplicara la eleccion al perfil activo.",
            },
            sbusout = {
                name                = "Salida SBUS",
